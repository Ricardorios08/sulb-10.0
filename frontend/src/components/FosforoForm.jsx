...
const FosforoForm = ({ initialData, onChange }) => {
  ...
  return (
    <div className="bg-white p-2 border-0">
      <div className="alert alert-info py-2 mb-3 d-flex align-items-center gap-2">
        <FaFlask />
        <span className="fw-bold text-uppercase small">Fosfatemia (363)</span>
      </div>

      <div className="row g-2">
        <InputField label="Diuresis 24 hs" field="diuresis" unit="L" col={6} />
        <InputField label="Fósforo" field="valor_hallado" unit="mg/24hs" col={6} />
      </div>
    </div>
  );
};

export default FosforoForm;