...
const CoombsForm = ({ initialData, onChange }) => {
  ...
  return (
    <div className="bg-white p-2 border-0">
      <div className="alert alert-danger py-2 mb-3 d-flex align-items-center gap-2">
        <FaFlask />
        <span className="fw-bold text-uppercase small">Test de Coombs (186)</span>
      </div>

      <div className="row g-2">
        <InputField label="Salino" field="salino" col={4} />
        <InputField label="Albuminoso" field="albuminoso" col={4} />
        <InputField label="Coombs" field="coombs" col={4} />
