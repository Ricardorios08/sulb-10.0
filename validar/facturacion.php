...
<div align="center">
    <!-- <li><a href="../a_sectores/secretaria/secretaria.php" target = "izquierda">Secretaria</a> </li> -->
     <table width="422" border="0">
       <tr>
         <th height="53" colspan="4" scope="col"><span class="Estilo8">SISTEMA DE FACTURACION </span></th>
       </tr>
       <tr>
         ...
         <th scope="col"><div align="center" class="Estilo3"><a href="../a_sectores/consulta_bq/consultas.php" target = "izquierda"><img src="../imagenes/botones/barra/consultas.jpg" alt="Consul. Bioq." width="80" height="80" border = "1" title="Consultas Varias"></a></div></th>
         <th scope="col"><div align="center" class="Estilo3"><a href="javascript:multicarga('../a_sectores/grabacion/grabacion_facturacion.php', '../a_sectores/grabacion/mensaje.php')"><img src="../imagenes/botones/barra/grabacion.jpg" alt="Grabacion" width="80" height="80" border = "1" title="Grabacion de Ordenes, Control de Ordenes, Pami, Consultas, etc"></a></div></th>
       </tr>
       <tr>
       ...
       <tr>
         <th scope="row"><div align="center" class="Estilo3"><a href="../a_sectores/estadistica/estadistica.php" target = "izquierda"><img src="../imagenes/botones/barra/estadistica.jpg" alt="Estadisticas" width="80" height="80" border = "1" title="Diferentes estadisticas, Ordenes, Recepcion, etc"></a></div></th>
         <td><div align="center" class="Estilo3"><a href="../a_sectores/facturacion/facturacion.php" target = "izquierda"><img src="../imagenes/botones/barra/facturacion.jpg" alt="Facturaci&oacute;n" width="80" height="80" border = "1"  title="Sistema para facturas Obras Sociales, Pre-Facturacion, Consultas"></a></div></td>
         <td><div align="center" class="Estilo3">
   <a href="../a_sectores/liquidacion/liquidacion.php"></a><a href="../a_sectores/recepcion/recepcion.php" target = "izquierda"><img src="../imagenes/recepcion.jpg" alt="Recepci&oacute;n" width="80" height="80" border = "1" title="Recepcion de Ordenes, Consultas, re-impresiones de planillas, etc."></a>
...
<!-- 		 <a href="../a_sectores/grabacion/grabacion.php" target = "izquierda"> -->
		 <A HREF="javascript:multicarga('../a_sectores/grabacion/grabacion.php', '../a_sectores/grabacion/mensaje.php')">		 </a><a href="javascript:multicarga('../a_sectores/grabacion/menu_pami.php', '../a_sectores/grabacion/control pami/mes_a_confirmar_pru.php')"><img src="../imagenes/botones/barra/grabacion.jpg" alt="Grabacion" width="80" height="80" border = "1" title="Grabacion de Ordenes, Control de Ordenes, Pami, Consultas, etc"></a></div></td>
       </tr>
       <tr>
         <th scope="row"><span class="Estilo5">ESTADISTICAS</span></th>
         <th><span class="Estilo5"><a href="manual/manual_facturacion.htm">FACTURACION</a></span></th>
         <th><span class="Estilo5">RECEPCION</span></th>
         <th><span class="Estilo5">CONTROL PAMI </span></th>
       </tr>
     </table>   
