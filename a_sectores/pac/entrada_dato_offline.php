...
<script src="../../css/js/1.12.4/jquery.min.js"></script>
...
<table width="850" border="0" cellspacing="0">
  ...
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td height="37" colspan="3" bgcolor="#666666"><div align="center" class="Estilo26">INGRESO DE PACIENTES FUERA DE LINEA U OBRAS SOCIALES PARTICULARES</div></td>
  </tr>
  <tr bordercolor="#FFFFFF">
    <td width="374" height="22" bgcolor="#B8B8B8">
      <div align="right" class="Estilo25">
        <div align="right"><font size="2">OBRA SOCIAL </font></div>
    </div></td>
...
?>
  ...
  <tr bordercolor="#FFFFFF">
    <td height="24" bgcolor="#B8B8B8"><div align="right"><font color="#000000" size="2">N&ordm; AFILIADO </font></div></td>
    <td colspan="2" bgcolor="#F0F0F0"><font color="#000000" size="2">
      <input name="numero_credencial_lector" type="text" id="numero_credencial_lector" class = 'ctxt' onKeyPress="return verif_caracter(this,event)"  size="14">
    </font></td>
  </tr>
  
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="3" valign="top" bgcolor="#666666"><div align="center">
        <input type="Submit" name="Submit" id ="GUARDAR" value="INGRESAR" class = 'btn btn-lg btn-primary'>
    </div></td>
  <tr>
    <td height="0"></td>
    <td width="155"></td>
