...
if (($usuario == 8236) or ($usuario == 1126)) {
$terminal=strtoupper($result->fields["sucursal"]);
}

?>
<table width="850" border="0" cellpadding="0">
  <tr>
    <th bgcolor="#FFFFCC" scope="col"><div align="center"><span class="Estilo1"><?PHP echo $cuit;?> <?PHP echo $prestador;?></span></div></th>
  </tr>
</table>
...
$terminal=$result10->fields["terminal"];
  ...
  $sql="select * from pacientes where nro_afiliado = '$nro_afiliado' and nro_os = '$nro_os' and usuario = '$usuario'";
$result = $db->Execute($sql);
...
include ("../pacientes/buscar_paciente_individual_aut.php");
exit;
}
