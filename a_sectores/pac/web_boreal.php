...
//ini_set('soap.wsdl_cache_ttl',0);
    ...
    $wsdlUrl = 'http://sistemasboreal.com.ar:5480/WsBoreal/servlet/awsboreal?wsdl';
    ...
    $checkVatParameters = array("Ingresoxml" => "<?xml version='1.0' encoding='iso-8859-1'?>".$xml);

    $result = $client->Execute($checkVatParameters);
  $result->Egresoxml;
}
catch(Exception $e) {
    $e->getMessage();
