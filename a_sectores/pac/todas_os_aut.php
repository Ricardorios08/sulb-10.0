...
<BODY onload = "on_load()">
<form action="guardar_abm_aut.php" method="post">
<?php 
...
*/
  ...
  $sql="select * from pacientes where usuario = $usuario ORDER BY nro_paciente_abm DESC";
$result = $db->Execute($sql);
 $nro_paciente_abm=($result->fields["nro_paciente_abm"] + 1);
...
if ($track != ""){
 ...
 $numero_credencial = $nro_afiliado;
  ...
  $sql="select * from pacientes where nro_afiliado = '$numero_credencial' and nro_os = '$nro_os' and usuario = $usuario";
$result = $db->Execute($sql);
...
include ("buscar_paciente_individual_aut.php");
exit;
}
...
/////////////////////////////////////////////////
if ($nro_os == 1041)  {
include_once ("web_itc1.php");
//}elseif ($nro_os == 4723){ // SWISS

  //$sql10="select * from datos_osde where cuenta_abm = '$usuario'";
//$result10 = $db->Execute($sql10);
 
  //$terminal=$result10->fields["sucursal_swiss"];
