...
<table width="840" border="0" cellspacing="0">
  ...
  <tr bordercolor="#FFFFFF">
    <td width="225" height="24" bgcolor="#B8B8B8" class="Estilo25">      <div align="right" class="Estilo25">
...
?>
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td colspan="2" bgcolor="#F0F0F0">      <div class="col-xs-6">
      ...
      </font><font color="#000000"><span class="Estilo33">Sólo para OSDE a partir del 01/12/2019 </span></font> </div></td>
  </tr>
...
<table width="818" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="middle" bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=1041"><img  src="os/osde.jpg"  alt="OSDE" width="105" height="76" class="hover_os" ></a></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=5080"><img  src="os/sancor.jpg"  alt="sancor" width="124" height="80" class="hover_os"></a></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=5396"><img  src="os/boreal.jpg"  alt="HOPE" width="101" height="57" class="hover_os" /></a></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=5073"><img class="hover_os"  src="os/pami.jpg"   alt="PAMI" width="100"  ></a></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=4723"><img  src="os/swiss.jpg"  alt="SWISS MEDICAL" width="94" height="88" class="hover_os" /></a></div></td>
    <td bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=5543"><img  src="os/staff.jpg"  alt="staff" width="124" height="80" class="hover_os"></a></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="20%" bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=1041"></a><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=2042"><img class="hover_os"  src="os/osapm.png"  alt="AAPM" width="61" ></a></div></td>
    <td width="10%" bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=5171"><img class="hover_os"  src="os/ospe.jpg" width="68"  alt="OSPE"></a></div></td>
    <td width="11%" bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=3771"><img class="hover_os"  src="os/osdipp.png"  alt="OSDIP"></a></div></td>
    <td width="15%" bgcolor="#FFFFFF"><div align="center"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=2462"><img class="hover_os"  src="os/servesalud.jpg" width="128"  alt="SERVESALUD"></a></div></td>
    <td width="15%" bgcolor="#FFFFFF"><div align="right"><a href="entrada_dato_abm.php?usuario=<?php print("$usuario");?>&&nro_os=5291"><img class="hover_os"  src="os/hope.png" width="100"  alt="HOPE"></a></div></td>
...
<table width="850" border="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><div align="center">60671956201</div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><div align="center">99999800405</div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><div align="center"> <strong>7180171000054 ó 8000067180171000054</strong> </div></td>
  </tr>
