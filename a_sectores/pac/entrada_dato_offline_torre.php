...
?>
<form action="chequear_apellido.php" method="post">
<table width="850" border="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td height="37" colspan="3" bgcolor="#666666"><div align="center" class="Estilo26">INGRESO DE PACIENTES POR APELLIDO </div></td>
  </tr>
...
?>
  ...
  <tr bordercolor="#FFFFFF">
    <td height="24" bgcolor="#B8B8B8">Apellido<font color="#000000" size="2">&nbsp; </font></td>
