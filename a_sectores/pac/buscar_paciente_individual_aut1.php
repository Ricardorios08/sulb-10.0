...
*/
   ...
   $sql="select * from pacientes where nro_paciente = '$palabra' and usuario = '$usuario'";
$result = $db->Execute($sql);

 $nro_paciente=$result->fields["nro_paciente"];
  $nro_paciente_abm=$result->fields["nro_paciente_abm"];
...
<table width="850" border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="294" colspan="-2" valign="middle" bgcolor="#EDEDED"><span class="Estilo40"><?php echo $apellido;?> <?php echo $nombre;?> (<?php echo $nro_paciente;?>) - <?php echo $nro_paciente_abm;?>)</span></td>
    <td width="379" rowspan="8" bgcolor="#EDEDED"><div align="center" style="width: 100%; height: 90px;"><a href="../grabacion/grabar_nuevo/grabacion_ordenes.php?nro_paciente=<?php print("$nro_paciente");?>&&nro_os=<?php print("$nro_os");?>&&usuario=<?php print("$usuario");?>" class="bot_receta1"><img src="../pac/alta.png" width="70" height="70" border="0" alt="">Orden</a><a class="bot_receta2" href="modificar.php?nro_paciente=<?php print("$nro_paciente");?>&&usuario=<?php print("$usuario");?>" target = "central"><img src="../pac/editar.png" width="70" height="70" border="0" alt="">Modificar</a><a class="bot_receta3" href="borra_todo.php?nro_paciente=<?php print("$nro_paciente");?>" onClick="return confirm('&iquest;Est&aacute; seguro de Borrar el paciente con toda su historia Clinica?');"><img src="../pac/borrar.png" width="70" height="70" border="0" alt="">Borrar</a><a class="bot_receta4" href="ficha.php?nro_paciente=<?php print("$nro_paciente");?>&&usuario=<?php print("$usuario");?>"><img src="../pac/ver_ficha.png" width="70" height="70" border="0" >Ficha</a></div></td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC">
...
$detalle = "detalle";
  ...
  $sql3="select * from $ordenes where nro_paciente = $nro_paciente and usuario = '$usuario' order by fecha_grabacion";
$result3 = $db->Execute($sql3);


 if (!$result3) die("fallo33".$db->ErrorMsg());
  while (!$result3->EOF) {
 ...
 ?>
  <table width="850" border="1" cellspacing="0">
    ...
    <tr >
      ...
      <td width="87" bgcolor="#666666"><div align="center"><span class="Estilo26">MODIFICAR</span></div></td>
    ...
    <tr bordercolor="#E0EDF3" bgcolor="#E0EDF3" style="cursor:hand" onMouseOver="this.style.background='#E1E1E1'; this.style.color='blue'" onMouseOut="this.style.background='#E0EDF3'; this.style.color='black'">
	  ...
	  <a href="../analisis/emision_mod_validar.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//011.ico" alt="Ficha" border = "0"></a></font></div></td>
      <td bgcolor="#EDEDED"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
	  
	  <a href="../pacientes/borra_orden.php?cod_grabacion=<?php print("$cod_grabacion");?>&&usuario=<?php print("$usuario");?>&&nro_paciente=<?php print("$nro_paciente");?>" onclick="return confirm('&iquest;Est&aacute; seguro de Borrar la orden y sus RESULTADOS?');"><IMG SRC="../../imagenes/office//1047.ico" alt="Borrar" border = "0"></a></font></div></td>
      <td bgcolor="#EDEDED"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
	  
	  <a href="../analisis/modelos_completar/elegir_modelos.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"></a></font><font size="1" face="Arial, Helvetica, sans-serif">
	  
	  <a href="../pacientes/autorizar.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"></a></font><font size="1" face="Arial, Helvetica, sans-serif">
	  
	  
	  <a href="../pacientes/anular_osde.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//951.ico" alt="Informe" border = "0"></a>
	  
	  
	  </font></div></td>
      <td bgcolor="#EDEDED"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
	  
	  <a href="../pacientes/autorizar_osde.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"></a>
	  
	  </font><font size="1" face="Arial, Helvetica, sans-serif">
	  
	  
	  <a href="../pacientes/autorizar_osde.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//951.ico" alt="Informe" border = "0"></a>
