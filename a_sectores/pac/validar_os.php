...
$cuenta_abm=strtoupper($result->fields["cuenta_abm"]);
 ...
 $sucursal=$result->fields["sucursal"];
  $sucursal_swiss=$result->fields["sucursal_swiss"];
 $matricula_swiss=$result->fields["matricula_swiss"];
  $cuit_swiss=$result->fields["cuit_swiss"];

$cod_seg=$_POST["cod_seg"];

if (($cod_seg == "") and ($nro_os == 1041)){

$leyenda = "NO INGRESO CODIGO DE SEGURIDAD";
include ("../../alertas/campo_informacion2.php");
exit;
}
