...
?>
  <tr>
    <td width="18" bgcolor="#EDEDED"><div align="left"><font color="#000000" size="2" face="Trebuchet MS"><a href="informe_pdf_individual.php?nro_os=<?php print("$id");?>" target  ="central"><?php print("$id");?></a></font></div></td>
    <td width="148" bgcolor="#EDEDED"><div align="left"><font color="#000000" size="2" face="Trebuchet MS"><?php print("$sigla");?></font></div></td>
    <td width="308" valign="middle" bgcolor="#EDEDED"><div align="left"><font color="#000000" size="2" face="Trebuchet MS"><?php print("$denominacion");?></font></div></td>
    <td width="63" valign="top" bgcolor="#EDEDED"><div align="center"><font color="#000000" size="2" face="Trebuchet MS"><a href="../../gerencia/ingresar_convenios.php?nro_os=<?php print("$id");?>&&sigla=<?php print("$sigla");?>" target  ="central"><img src="../../../imagenes/office//035.ico" alt="Ficha" border = "0"></a></font></div></td>
    <td width="57" valign="top" bgcolor="#EDEDED"><div align="center"><font color="#000000" size="2" face="Trebuchet MS"><a href="../../requisitos/entrada_requisitos.php?nro_os=<?php print("$id");?>&&sigla=<?php print("$sigla");?>" target  ="central"><img src="../../../imagenes/office//035.ico" alt="Ficha" border = "0"></a></font></div></td>
        <td width="45" valign="top" bgcolor="#EDEDED"><div align="center"><font color="#000000" size="2" face="Trebuchet MS"><a href="modificar.php?id=<?php print("$id");?>" target  ="central"><img src="../../../imagenes/office//027.ico" alt="Ficha" border = "0" ></a></font></div></td>
    <td width="58" valign="top" bgcolor="#EDEDED"><div align="center"><font color="#000000" size="2" face="Trebuchet MS"><a href="borra.php?id=<?php print("$id");?>" target  ="central"><img src="../../../imagenes/office//1047.ico" alt="Ficha" border = "0" onClick="return confirm('¿Está seguro de Borrar?');"></a></font></div></td>
    <td width="42" valign="top" bgcolor="#EDEDED"><div align="center"><font color="#000000" size="2" face="Trebuchet MS"><a href="ficha.php?id=<?php print("$id");?>" target  ="central"><img src="../../../imagenes/office//005.ico" alt="Ficha" border = "0" ></a></font></div></td>
  </tr>
  <tr><td colspan="9" bgcolor="#EDEDED">
...
?>
  <tr bordercolor="#FFFFCC">
    <td colspan="9" bgcolor="#B8B8B8"><font size="2" face="Trebuchet MS">Cantidad de Obras Sociales: <?php echo $cont;?></font></td>
  </tr>
