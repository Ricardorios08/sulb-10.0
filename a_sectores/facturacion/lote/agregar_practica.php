...
<table width="850" border="0">
  <!--DWLayoutTable-->
  <tr align="center">
    <td height="37" colspan="2" bgcolor="#B8B8B8"><strong> NUEVO LOTE </strong></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF">
    <td height="24" bgcolor="#B8B8B8"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Nombre lote 
