...
<table width="829" border="1" align="center" cellspacing="0">
 <tr >
   ...
   <td width="354" bgcolor="#666666"><div align="center" class="Estilo35">Paciente</div></td>
    ...
    <td width="36" bgcolor="#666666"><div align="center" class="Estilo29 Estilo35">
      <div align="center">A5.</div>
    </div></td>
    <td width="36" bgcolor="#666666"><div align="center" class="Estilo35">A4</div></td>
 </tr>
...
$nombre_completo = substr($nombre_completo,0,20);
 ...
 <tr bordercolor="#E0EDF3" bgcolor="#E0EDF3" style="cursor:hand" onMouseOver="this.style.background='#E1E1E1'; this.style.color='blue'" onMouseOut="this.style.background='#E0EDF3'; this.style.color='black'">
   ...
   <td bgcolor="#E0EDF3"> <?php echo $nombre_completo;?> <?php echo $nro_paciente;?> </td>
    ...
    <td bgcolor="#E0EDF3"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="../analisis/modelos/elegir_modelos_idema_a4.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//005.ico" alt="Informe" border = "0"></a></font></div></td>
 </tr>
<?php 
