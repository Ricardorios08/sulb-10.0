...
<body class="cover" style="background-image: url(librerias/assets/img/fondo.jpg);">
...
<div class="container" style=" background-color: #fff;">
	...
	<div class="row">
		<div class="col-md-6 col-lg-6 ">
			...
			<p align="center" class="Estilo2">Descarga de informes - <a href="../../index.php">Salir</a></p>
		</div>
	</div>
   ...
   <div class="row">
    <div class="col-sm-12 col-lg-4">
     <?php echo $fecha_grabacion;?>
       ...
       <div class="col-sm-12 col-lg-4">
    <?php echo $nombre_completo;?> <?php  $nro_paciente;?>
    </div>
       <div class="col-sm-12 col-lg-4">
