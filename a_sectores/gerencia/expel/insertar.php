...
ECHO $binario_nombre_temporal=$_FILES['archivo']['tmp_name'] ;
EXIT;
...
mysql_select_db("laboratorio",$conexion) or die("No se puede seleccionar BD"); // tu_bd es el nombre de la Base de datos .. por siaca.
