...
include("../../../conexiones/config.inc.php");
	 ...
	 $sql="select * from convenio_practica order by cod_practica asc";
...
if ($honorarios != $honorarios2012){
 ...
 $sql = "UPDATE `convenio_practica` SET `honorarios` = '$honorarios2012' WHERE `cod_practica` = $cod_practica";
//mysql_query($sql);
...
$cant = $cant +1;
 ...
 $sql = "UPDATE `convenio_practica` SET `practica` = '$practica2012' WHERE `cod_practica` = $cod_practica";
//mysql_query($sql);
...
<?php  $sql = "delete from `convenio_practica` where cod_practica  = $cod_practica";
//mysql_query($sql);
?>
...
// echo $sql = "INSERT INTO `convenio_practica` ( `cod_practica` , `nro_os` , `cod_equivalencia` ,`categoria` , `honorarios` , `gastos` , `toma` , `urgencia` , `material_descartable` , `valor` , `autorizada` ) VALUES ( '$cod_practica' , '4975' , '$equivalencia' , '$categoria' , '$honorarios' , '$gastos' , '$toma' , '$urgencia' , '$material_descartable' , '$valor' , '$autorizada')";

 $sql = "INSERT INTO convenio_practica (`cod_practica`, `nro_os`, `cod_equivalencia`, `categoria`, `honorarios`, `gastos`, `valor`, `practica`, `metodo`, `referencia`, `prioridad`, `salto`, `referencia1`, `referencia2`, `referencia3`, `unidad`, `nueva`, `por`, `tipo_det`) VALUES ('$cod_practica', '4975', '$cod_equivalencia', '$categoria', '$honorarios', '$gastos', '$valor', '/$practica2012/', '$metodo', '$referencia', '$prioridad', '$salto', '$referencia1', '$referencia2', '$referencia3', '$unidad', '$nueva', '$por', 'Ninguna')";
