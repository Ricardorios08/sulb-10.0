...
.Estilo40 {font-size: 12px; font-family: "Trebuchet MS"; color: #FFFFFF; }
-->
</style>
...
<table width="784" border="1" cellspacing="0">
  ...
  <tr >
    <td colspan="7" valign="top"><div align="center" class = "titulo">Listado de Pacientes</div></td>
  </tr>
  <tr>
    <!-- <td width="68" bgcolor="#B8B8B8"><div align="center" class="Estilo35">Ultima Atenci&oacute;n </div></td> -->
    <td width="285" bgcolor="#666666"><span class="Estilo40">Nombre y Apellido del Paciente </span></td>
	<td width="46" bgcolor="#666666"><div align="center" class="Estilo40">Sexo </div></td>
    <td width="62" bgcolor="#666666"><div align="center" class="Estilo33">Afiliado</div></td>
    <td colspan="2" bgcolor="#666666"><div align="center" class="Estilo40">Obra Social </div></td>

    <td width="118" bgcolor="#666666"><div align="center" class="Estilo40">Historia  </div></td>
  </tr>
...
<td valign="middle" bgcolor="#FFFFFF"><div align="center" class="Estilo37"><font size="1"><span class="Estilo3"><?php echo $sexo;?></span></font></div></td>
    ...
    <td width="35" valign="middle" bgcolor="#FFFFFF"><div align="center" class="Estilo35"><span class="Estilo37"><?php echo $nro_os;?></span></div></td>
    <td width="212" valign="middle" bgcolor="#FFFFFF"><span class="Estilo37"><span class="Estilo35"><?php echo $sigla;?></span></span></td>
    <td valign="middle" bgcolor="#FFFFFF"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="buscar_paciente_individual_validar.php?palabra=<?php print("$nro_paciente");?>&&usuario=<?php print("$usuario");?>" target = "central"><img src="../../imagenes/office//027.ico" alt="Modificar" border = "0"></a></font></div></td>
  </tr>
