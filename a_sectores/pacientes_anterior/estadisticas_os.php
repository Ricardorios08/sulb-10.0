...
<?php   $sql3="select nro_os from ordenes group by nro_os  order by nro_os ";
$result3 = $db->Execute($sql3);

if (!$result3) die("fallo4".$db->ErrorMsg());
	 while (!$result3->EOF) {

$nro_os=$result3->fields["nro_os"];
...
<table width="850" border="0" bgcolor="#FFFFFF">
  <!--DWLayoutTable-->
  <tr>
    <td height="20" valign="top"><div align="center" class="Estilo4 Estilo11">
      <div align="left">OBRA SOCIAL: <?php ECHO $denominacion;?></div>
    </div>      </td>
  </tr>
</table>
...
<!-- <td><div align="center" class="Estilo12"><span class="Estilo3">DESCRIPCION</span></div></td> -->
	<td width="365" height="21" valign="top"><div align="center" class="Estilo12"><strong><span class="Estilo3">PRACTICA.</span></strong></div></td>
    <td width="61" valign="top"><div align="center" class="Estilo12"><strong><span class="Estilo3">CANT</span></strong></div></td>
	<td colspan="2" valign="top"><div align="center" class="Estilo12"><strong><span class="Estilo3">PRACTICA.</span></strong></div></td>
    <td width="80" valign="top"><div align="center" class="Estilo12"><strong><span class="Estilo3">CANT</span></strong></div></td>
  </tr>
</TABLE>
...
$laboratorio = "ei000052_laboratorio";
$laboratorio = "laboratorio";

  $sql2 = "SELECT $laboratorio.detalle.cod_grabacion, $laboratorio.detalle.nro_practica, $laboratorio.ordenes.fecha, COUNT($laboratorio.detalle.nro_practica) as repeticiones FROM $laboratorio.detalle INNER JOIN $laboratorio.ordenes ON $laboratorio.detalle.cod_grabacion = $laboratorio.ordenes.cod_grabacion WHERE $laboratorio.ordenes.fecha between '$desde' and '$hasta'  and ordenes.nro_os = $nro_os group by $laboratorio.detalle.nro_practica order by repeticiones desc";
