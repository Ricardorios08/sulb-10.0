...
<table width="829" border="0" cellspacing="0">
 ...
 <tr>
    <td width="109" valign="middle" bgcolor="#CCCCCC"><div align="right"><a href="../grabacion/grabar_nuevo\grabacion_ordenes.php?nro_paciente=<?php print("$nro_paciente");?>&&nro_os=<?php print("$nro_os");?>&&usuario=<?php print("$usuario");?>&&tipo_operador=val"> </a>PACIENTE:</div></td>
...
<table width="829">
  <tr>
<td height="8" colspan="12"><div align="center" class="Estilo31">NO EXISTE PACIENTE CON ESAS CARACTERISTICAS</div>  <div align="center" class="titulo"><a href="../pac/entrada_dato_abm.php?nombre=<?php print("$palabra");?>" class="Estilo28">INGRESAR NUEVO PACIENTE</a></span></div></td>
</tr>
</table>
<?php }else{?>
  <tr>
