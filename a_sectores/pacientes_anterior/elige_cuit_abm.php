...
<form action="abm_ws_varios.php" method="post">
...
$cuenta_abm=strtoupper($result->fields["cuenta_abm"]);
 ...
 ?>
<tr>
  <td width="858" height="30" bgcolor="#B8B8B8"><div align="center"><span class="Estilo5">SELECCIONE EL CUIT QUE DESEA AUTORIZAR OSDE </span></div></td>
</tr>
<tr>
    <td> <?php 
