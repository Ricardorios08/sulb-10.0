...
switch ($planillas){
case "1":{ 	include ("buscar_paciente_diaria_validar.php"); 		break; 	} //Diaria 
case "2":{ 	include ("buscar_paciente_mega.php"); 		break; 	} //Mega
case "3":{ 	include ("buscar_paciente_lista_validar.php"); 		break; 	} //Pacientes
...
case "7":{ 	include ("buscar_paciente_osde_validar.php"); 		break; 	} //Practicas
