...
<table width="215" border="1">
  <tr>
    ...
    <td width="98"><div align="center"><a href="buscar_paciente.php?palabra=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>">Reimprimir</a></div></td>
  </tr>
</table>
<?php
...
<table width="315" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#B8B8B8"><div align="center" class="Estilo56">VALIDACION SANCOR - SULB </div></td>
  </tr>

  <tr>
    <td bgcolor="#F0F0F0"><span class="Estilo3 Estilo1">Fecha Validación: <?php echo $fecha_osde;?> ></span></td>
  </tr>
  ...
  <tr>
    <td bgcolor="#F0F0F0"><div align="left" class="Estilo3"><span class="Estilo3 Estilo1">Afiliado: <?php echo $apellido;?>, <?php echo $nombre;?></span></div>     </td>
  </tr>
  <tr>
    <td bgcolor="#F0F0F0"><span class="Estilo3 Estilo1">N&deg; Credencial: <?php echo $numero_credencial;?></span></td>
  </tr>
  ...
  <tr>
    <td bgcolor="#B8B8B8"><div align="center"><span class="Estilo3 Estilo1">Rta Sancor:</span></div></td>
  </tr>
  <tr>
...
$practica=strtoupper($result8->fields["practica"]);
 ...
 ?>  <tr>
     <td height="21" bgcolor="#F0F0F0"><span class="Estilo4 Estilo1">&nbsp;&nbsp;&nbsp;<?php echo $nro_practica;?> - <?php echo $practica;?></span></td>
   </tr>
...
<table width="315" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="24" colspan="2" valign="top" bgcolor="#B8B8B8"><div align="center" class="Estilo56">VALIDACION BOREAL - SULB </div></td>
  </tr>

  <tr>
    <td height="22" colspan="2" valign="top" bgcolor="#F0F0F0"><span class="Estilo3 Estilo1">Fecha Validación: <?php echo $fecha_osde;?></span></td>
  </tr>

  <tr>
    <td height="21" colspan="2" valign="top" bgcolor="#F0F0F0"><span class="Estilo3 Estilo1"><?php echo $nro_laboratorio1;?> <?php echo $prestador;?></span></td>
  </tr>

  <tr>
    <td height="22" colspan="2" valign="top" bgcolor="#F0F0F0"><span class="Estilo3 Estilo1">Cuit: <?php echo $cuit;?></span></td>
  </tr>
  <tr>
    <td height="22" colspan="2" valign="top" bgcolor="#F0F0F0"><div align="left" class="Estilo3"><span class="Estilo3 Estilo1">Afiliado: <?php echo $apellido;?>, <?php echo $nombre;?></span></div></td>
  </tr>
  <tr>
    <td height="22" colspan="2" valign="top" bgcolor="#F0F0F0"><span class="Estilo3 Estilo1">N&deg; Credencial: <?php echo $numero_credencial;?></span></td>
  </tr>
  

  <tr>
    <td height="22" colspan="2" valign="top" bgcolor="#F0F0F0"><span class="Estilo3 Estilo1">Plan: <?php echo $Planrta;?></span></td>
  </tr>
  <tr>
    <td height="20" colspan="2" valign="top" bgcolor="#B8B8B8"><div align="center"><span class="Estilo3 Estilo1">Rta BOREAL:</span></div></td>
  </tr>
  <tr>
    <td height="21" colspan="2" valign="top" bgcolor="#F0F0F0"><div align="center"><span class="Estilo3 Estilo1"><span class="Estilo5"> <?php echo $Descripcionrespuesta;?></span></span></div></td>
  </tr>

<tr>
  <td width="286" bgcolor="#B8B8B8"><div align="center"><span class="Estilo3 Estilo1">Practicas informadas </span></div></td>
  <td width="23" bgcolor="#B8B8B8"><div align="center"><span class="Estilo4">Cos.</span></div></td>
</tr>
<tr>
  <td>&nbsp;</td>
...
<td bgcolor="#F0F0F0"><span class="Estilo4 Estilo1">&nbsp;&nbsp;&nbsp;<?php echo $nro_practica;?> - <?php echo $practica;?> <?php echo $PracticaObs;?></span></td>
...
<table width="315" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#B8B8B8"><div align="center" class="Estilo56">VALIDACION PAMI - SULB </div></td>
  </tr>
  ...
  <tr>
    <td bgcolor="#B8B8B8"><div align="center"><span class="Estilo3 Estilo1">Rta PAMI</span></div></td>
  </tr>
  <tr>
    <td bgcolor="#F0F0F0"><div align="center"><span class="Estilo3 Estilo1"><span class="Estilo5"> <?php echo $Descripcionrespuesta;?></span></span></div></td>
  </tr>
...
<table width="216" border="0" cellpadding="0">
  <tr>
