...
<table width="103%" cellpadding="3" cellspacing="0" BORDER = "0">
 ...
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   <td width="38%" class="left" ><div align="center" class="Estilo8 Estilo9">
   ...
   <td width="23%" class="left" ><div align="right"><span class="left Estilo1"><span class="Estilo13"><span class="Estilo9">Periodo:          <strong>
 ...
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   ...
   <td class="left Estilo1" >Afiliado: <span class="right"><span class="Estilo17"><?php echo $nombre." ".$afiliado;?>
   ...
   <td class="left" ><div align="right" class="Estilo1">Prescriptor: <span class="right"><strong><?php echo $nombre_pres. " ".$prescriptor;?>
 ...
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   ...
   <td class="left" ><div align="center" class="Estilo15">
     <div align="right">Coseguro: <strong><?php echo $coseguro;?>
...
$medico=$_REQUEST["prescriptor"];
 ...
 $autorizacion=$_REQUEST["autorizacion"];
 $año = date("y");
$cod_grabacion=trim($nro_os.$matricula.$nro_orden);
