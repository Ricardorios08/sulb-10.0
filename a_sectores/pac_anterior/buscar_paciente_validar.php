...
}else
{
 ...
 $sql="select * from pacientes where nro_paciente like '$palabra'  or nro_documento like '$palabra%' or  nro_afiliado like '$palabra%'  order by nombre";
}
}
...
<table width="850" border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="379" rowspan="8" bgcolor="#EDEDED"><div align="center"><a href="../grabacion/grabar_nuevo/grabacion_ordenes.php?nro_paciente=<?php print("$nro_paciente");?>&&nro_os=<?php print("$nro_os");?>&&usuario=<?php print("$usuario");?>" class="Estilo2"><img src="../../imagenes/bt_orden1.png" alt="INGRESAR NUEVA ORDEN MEDICA" border = "0"></a><a href="modificar.php?nro_paciente=<?php print("$nro_paciente");?>&&usuario=<?php print("$usuario");?>" target = "central"><img src="../../imagenes/bt_modificar.png" alt="Modificar" border = "0"></a><a href="borra_todo.php?nro_paciente=<?php print("$nro_paciente");?>" onClick="return confirm('&iquest;Est&aacute; seguro de Borrar el paciente con toda su historia Clinica?');"><img src="../../imagenes/bt_borrar.png" alt="Borrar" border = "0"></a><a href="ficha.php?nro_paciente=<?php print("$nro_paciente");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/bt_ficha.png" alt="Ficha" border = "0"></a></div></td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC">
 ...
 <tr >
    ...
    <td bgcolor="#666666"><div align="center" class="Estilo27">
      <div align="center">Pr&aacute;cticas Solicitadas </div>
	    ...
	    <td width="36" bgcolor="#666666"><div align="center"><span class="Estilo26">BORRAR</span></div></td>
...
<a href="anular_osde.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//951.ico" alt="Informe" border = "0"></a></font></div></td>
...
<table width="850">
  <tr>
<td height="8" colspan="12"><div align="center" class="Estilo31">NO EXISTE PACIENTE CON ESAS CARACTERISTICAS</div>  <div align="center" class="titulo"><span class="Estilo28"><a href="entrada_dato_abm.php?nombre=<?php print("$palabra");?>" class="Estilo28">INGRESAR NUEVO PACIENTE</a></span></div></td>
</tr>
</table>
<?php }else{?>
  <tr>
