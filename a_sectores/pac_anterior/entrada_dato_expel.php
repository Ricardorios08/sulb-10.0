...
<table width="800" border="0" cellspacing="0">
    ...
    <tr align="center" bordercolor="#FFFFFF">
      <td width="147"><!--DWLayoutEmptyCell-->&nbsp;</td>
    ...
    <tr bordercolor="#FFFFFF">
      ...
      <input name="nro_afiliado" type="text" id="nro_afiliado"onKeyPress="return verif_caracter(this,event)"  size="20" maxlength="20">      
      </font></td>
  </tr>
    <tr bordercolor="#FFFFFF">
      <td><!--DWLayoutEmptyCell-->&nbsp;</td>
    ...
    <tr bordercolor="#FFFFFF">
      ...
      <td colspan="2">        <font color="#000000" size="2"><strong><font color="#000000" size="2">
  ...
  <tr bordercolor="#FFFFFF">
      ...
      <td colspan="2"><font color="#000000" size="2"><strong><font color="#000000" size="2">
        <?php 
$sql = "SELECT * FROM datos_os order by nro_os, nro_os, sigla";
$result = $db->Execute($sql);
...
<input type="text" name="anio" id="anio"onKeyPress="return verif_caracter(this,event)" size="3" maxlength="4">
  ...
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="3" valign="top"><div align="center">
      <input type="Submit" name="Submit" id ="GUARDAR" value="GUARDAR PACIENTE">
    </div></td>
    <td width="509" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
  <tr>
    <td></td>
    <td height="0"></td>
    <td width="185"></td>
