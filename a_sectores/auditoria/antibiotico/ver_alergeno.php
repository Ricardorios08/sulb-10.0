...
<html>
<head>
<title>LISTADO DE ANTIBIOTICOS</title>
...
include ("../../../conexiones/config.inc.php");
 ...
 $sql="select * from rast  order by rast";
$result = $db->Execute($sql);
 ...
 $cod_rast=strtoupper($result->fields["cod_rast"]);
...
?>
  ...
  <tr>
    <td colspan="-2" valign="middle" bgcolor="#F0F0F0"><span class="Estilo40"><?php echo $rast;?></span></td>
    <td bgcolor="#F0F0F0"><div align="center"><a href="borra_alergeno.php?cod_rast=<?php print("$cod_rast");?>" onClick="return confirm('&iquest;Est&aacute; seguro de Borrar el Alergeno?');"><img src="../../../imagenes/office//1047.ico" alt="Borrar" border = "0"></a></div></td>
  </tr>
