...
include ("../../../conexiones/config.inc.php");
 ...
 $sql="select * from antibioticos  order by antibiotico";
$result = $db->Execute($sql);
 ...
 $cod_antibiotico=strtoupper($result->fields["cod_antibiotico"]);
...
?>
  ...
  <tr>
    ...
    <td bgcolor="#F0F0F0"><div align="center"><a href="borra.php?cod_antibiotico=<?php print("$cod_antibiotico");?>" onClick="return confirm('&iquest;Est&aacute; seguro de Borrar el Antibiotico?');"><img src="../../../imagenes/office//1047.ico" alt="Borrar" border = "0"></a></div></td>
  </tr>
