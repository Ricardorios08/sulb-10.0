...
$cod_operacion=strtoupper($result10->fields["cod_operacion"]);
 ...
 $sql10="SELECT * FROM convenio_practica_complejo where cod_practica = $cod_practica";
$result10 = $db->Execute($sql10);
$cantidad_renglones=strtoupper($result10->fields["cantidad_renglones"]);
...
?>
  ...
  <tr align="center" bordercolor="#FFFFFF">
    ...
    <td colspan="3" bgcolor="#F0F0F0"><div align="left"><span class="Estilo42"></span></div></td>
    </tr>
		  <tr align="center" bordercolor="#FFFFFF">
		    <td colspan="3" bgcolor="#F0F0F0"><div align="left"><span class="Estilo42">Cantidad de Renglones : <span class="Estilo3"><strong><?php echo $cantidad_renglones;?> </strong></span></span></div></td>
