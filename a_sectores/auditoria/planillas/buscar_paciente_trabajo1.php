...
?>
 ...
 <table width="100%" border="1" cellspacing="0">
  ...
  <table width="100%" height="100%" border="1" cellspacing="0">
    <tr>
	 <td width="60" height="22" bgcolor="#F0F0F0"><div align="center"></div></td>
      <td width="69" bgcolor="#F0F0F0">&nbsp;</td>
...
$result20->MoveNext();
	 ...
	 <tr><td width="60" height="22" bgcolor="#F0F0F0"><div align="center">Nº</div></td>
...
$contame = $contame + 1;
    ...
    ?>  <td width="301" height="22" bgcolor="#F0F0F0"><div align="center"><?php echo $cod_practica;?></div></td>
...
<tr><td width="60" height="22" bgcolor="#F0F0F0"><div align="center"><?php echo $conta;?></div></td>
  <td width="69" bgcolor="#F0F0F0"><div align="center"><?php echo $cod_grabacion;?></div></td>
  <td width="856" height="22" bgcolor="#F0F0F0"><div align="left"></div>   <?php echo $nombre_completo;?></td>
<?PHP
