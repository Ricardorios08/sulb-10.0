...
<form action="guardar_gastos_honorarios.php" method="post">
<table width="557" border="1">
  ...
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
    ...
    <td colspan="3"><div align="left">
      <input type="text" value ="<?php print("$cod_practica");?>" name="cod_practica" size ="10">
      <input type="text" value ="<?php print("$practica");?>" name="practica" >
    </div></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFCC">
    <td bgcolor="#FFFF99"><div align="right"><font color="#006633"><strong>Codigo de Equivalencia</strong></font></div></td>
    <td colspan="3"><div align="left">
        <input type="text" name="equivalencia" size ="10" id="equivalencia" >
    </div></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
    <td width="173" bgcolor="#FFFF99"><div align="right"><font color="#006633"><strong>Categoria</strong></font></div></td>
    <td width="148" colspan="3"><div align="left">        
  ...
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFCC">
    <td bgcolor="#FFFF99"><div align="right"><font color="#006633"><strong>Gastos</strong></font></div></td>
    <td colspan="3"><div align="left">
      <input type="text" name="gastos" size ="10" id="valor2" >
    </div></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF" bgcolor="#FFFFCC"> 
