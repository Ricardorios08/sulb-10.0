...
<table width="103%" cellpadding="5" cellspacing="0">
  ...
  <tr >
    ...
    <td class="left" ><div align="center"><span class="right">
        <input type="text" size="10" name="fecha_orden"   id="fecha_orden" onKeyPress="return verif_caracter(this,event)">
    </span></div></td>
    <td class="left" ><div align="center"><span class="right">
  ...
  <tr>
	...
	<td height="28" colspan="7" valign="top" bgcolor="#C9FADF" class="Estilo4" > Fecha: INVALIDA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </td>
</table>
