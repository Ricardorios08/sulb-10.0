...
<BODY onload = "on_load ()" >
<form action ="cambiar_laboratorio.php" method="post">
  <div align="left"></div>
  <table width="103%" border="0">
    <tr bgcolor="#000099">
      <td height="29" colspan="2"><div align="center"><span class="Estilo35">CAMBIAR ORDENES DE UN LABORATORIO A OTRO </span><br>
      </div></td>
    </tr>
    <tr bgcolor="#DAFAFC" >
    ...
    <tr bgcolor="#DAFAFC" >
      <td width="276" bgcolor="#000099"><div align="right" class="Estilo33">Laboratorio Actual </div></td>
      <td bgcolor="#E1F2EF" class="Estilo4"><span class="Estilo3">
        <input type="text" name="nro_laboratorio" id= "nro_laboratorio" size ="6">
      </span></td>
    </tr>
		    <tr bgcolor="#DAFAFC">
    <td bgcolor="#000099"><div align="right" class="Estilo14 Estilo3 Estilo32">Laboratorio a cambiar : </div></td>
    <td bgcolor="#E1F2EF">      <span class="Estilo4"><span class="Estilo3">
      <input type="text" name="nro_laboratorio_nuevo" id= "nro_laboratorio_nuevo" size ="6">
