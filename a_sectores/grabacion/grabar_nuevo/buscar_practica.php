...
<td width="19%" bgcolor="#CCCCCC"><div align="center"><font color="#000000" size="2"><strong>ACODIGO</strong></font></div></td>
...
<a href="pagina_completa_reducida.php?cod_practica=<?php print("$cod_practica");?>&&cod_grabacion=<?php print("$cod_grabacion");?>"> <?php print("$practica");?></a>
