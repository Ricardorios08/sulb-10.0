...
$anio= $_REQUEST['anio'];
echo $actualiza = $_REQUEST["actualiza"];
...
include ("../../../conexiones/config_gb.php");
 $sql = "SELECT * FROM `ordenes` WHERE (nro_orden != 0) && periodo = $periodo AND ano = $anio AND nro_os = $nro_os AND operador = $operador ORDER BY nro_orden DESC";
$result = $db->Execute($sql);

$nro_ord=strtoupper($result->fields["nro_orden"]);

$nro_temp = substr($nro_ord, 3,5);
$nro_temp = $nro_temp +1;

$nro_temp= ceros_nro_temp($nro_temp);
$nro_orden = $operador.$nro_temp;
...
&&anio_o=<?php print("$anio_o");?>&anio=<?php print("$anio");?>&nro_os=<?php print("$nro_os");?>&&operador=<?php print("$operador");?>
...
$anio_o= substr($fecha,4,2);
$dia= substr($fecha,0,2);
$mes_1 = substr($fecha,2,2);
...
$sql1= "DELETE FROM `ordenes` WHERE cod_grabacion = $cod_grabacion1";
mysql_query($sql1);

$sql = "INSERT INTO `ordenes` ( `cod_grabacion` , `periodo` , `ano` , `nro_os` , `nro_laboratorio` ,`matricula` , `nro_afiliado` ,`nro_orden` , `fecha` ,`medico` , `coseguro` , `autorizacion` , `fecha_fac` , `nro_fac` , `confirmada` , `marca` , `lote` , `operador` ) VALUES ( '$cod_grabacion1' , '$mes' , '$año' , '$nro_os' , '$nro_laboratorio' , '$matricula' , '$nro_afiliado' , '$nro_orden' , '$fecha_a' , '$medico' ,'$coseguro' , '$autorizacion' , '' , '' , 7 , '' , '$lote' , '$operador')";
mysql_query($sql);
}
else
					{
...
$sql ="INSERT INTO `detalle` ( `cod_grabacion` , `nro_os` , `nro_laboratorio` , `nro_orden` , `nro_practica` , `valor` , `periodo` , `ano` , `nro_factura` , `confirmada` , `cod_operacion` , `marca` , `lote`, `operador`  ) VALUES ('$cod_grabacion1' , '$nro_os' , '$nro_laboratorio' , '$nro_orden' , '$nro_practica' , '$valor' ,'$mes' , '$año' , '$nro_factura' , '7' , '' , '' , '$lote' , '$operador')";
mysql_query($sql);
