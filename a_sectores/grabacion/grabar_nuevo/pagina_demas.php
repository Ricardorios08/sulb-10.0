...
<table width="103%" cellpadding="3" cellspacing="0">
 ...
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   <td class="left" ><span class="left Estilo6"><span class="Estilo17">Operdor: <strong><?php php echo $operador." - ".$nombre_operador;?></strong></span></span></td>
 </tr>
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   <td class="left" ><span class="left Estilo6"><span class="Estilo17">Nombre Lote:<strong>"<?php php echo $lote;?>&quot;</strong></span></span></td>
 </tr>
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   <td class="left" ><div align="center" class="Estilo17">
     <div align="left">Obra Social : <span class="Estilo11">
     <input type="hidden" size="4" name="nro_os" value="<?php php echo $nro_os;?>">
     <?php php echo$sigla;?> - <?php php echo $nro_os;?></span></div>
 ...
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   ...
   <input type="hidden" size="4" name="nro_laboratorio" value="<?php php echo $nro_laboratorio;?>">
   <?php php echo $nombre_laboratorio;?> <?php php echo $nro_laboratorio;?> </strong></span></td>
   </tr>
 <tr bgcolor="#E1F2EF" class="Estilo4" >
   <td class="left" ><span class="left  Estilo1">Mes: <strong>
   <input type="hidden" size="1" name="periodo" onKeyPress="return verif_caracter(this,event)" class="text" value="<?php php echo $periodo;?>" id="periodo22">
   <input name="lote" type="hidden" value="<?php php echo $lote;?>">
   <?php php echo $mes1;?> <?php php echo $periodo;?></strong></span></td>
      <input name="anio" type="hidden" value="<?php php echo $anio;?>">
	   <input name="operador" type="hidden" value="<?php php echo $operador;?>">
   </tr>
 </table>
...
<table width="103%" cellpadding="1" cellspacing="0">
 ...
 <tr>
   ...
   <td width="80%" bgcolor="#E1F2EF" class="left" ><span class="right">
     <input name="afiliado" type="text" id="afiliado" value="<?php php echo $afiliado;?>" onKeyPress="return verif_caracter(this,event)"   size="14" maxlength="14">
  <?php php echo $tipo_afiliado;?> </span></td>
  </tr>
 <tr>
   <td bgcolor="#E6E6E6" ><div align="right" class="Estilo27">Prescriptor:</div></td>
   <td bgcolor="#E1F2EF" class="left" ><span class="right">
     <input name="prescriptor" type="text" id="prescriptor" value="<?php php echo $prescriptor;?>" onKeyPress="return verif_caracter(this,event)"  size="6" maxlength="6">
     <?php php echo $nombre_prescriptor;?> </span></td>
  </tr>
 <tr>
   <td bgcolor="#E6E6E6" ><div align="right"><span class="Estilo19 Estilo20 Estilo23"><span class="right">N&ordm; Orden:</span></span></div></td>
   <td bgcolor="#E1F2EF" class="left" ><span class="right">
     <input name="nro_orden" type="text"  id="nro_orden" value="<?php php echo $nro_orden;?>" onKeyPress="return verif_caracter(this,event)" size="14" maxlength="8" >
   </span></td>
 </tr>
 <tr>
   <td bgcolor="#E6E6E6" ><div align="right" class="Estilo27">Fecha Practica: </div></td>
   <td bgcolor="#E1F2EF" class="left" ><span class="right">
     <input type="text" size="2" name="dia"  value="<?php php echo $dia;?> id="dia" onKeyPress="return verif_caracter(this,event)" maxlength="2">
     /
     <input type="text" size="2" name="mes"  value="<?php php echo $mes;?> id="mes" onKeyPress="return verif_caracter(this,event)" maxlength="2">
     /
     20
     <input type="text" size="2" name="anio_o"  value="<?php php echo $anio_o;?> id="anio" onKeyPress="return verif_caracter(this,event)" maxlength="2">
   </span></td>
  </tr>
 <tr>
 ...
 <tr>
   ...
   <td bgcolor="#E1F2EF" class="left" ><span class="right">
<?php php   if ($nro_os == 3764){?>
     <input type="text" size="5" name="coseguro" id="coseguro" value = "<?php php echo $coseguro;?>" 	 onKeyPress="return verif_caracter(this,event)" disabled>
<?php php }else{?>
     <input type="text" size="5" name="coseguro" id="coseguro" value = "<?php php echo $coseguro;?>" 	 onKeyPress="return verif_caracter(this,event)">
	 <?php php }?>

	 <input name="tipo_afiliado" type="hidden" value="<?php php echo $tipo_afiliado;?>">
