...
<table width="850" border="1" cellspacing="0" bgcolor="#FFFFFF">
  <!--DWLayoutTable-->
   <tr bgcolor="#C5C5C5">
	 ...
	 <?php if ($nro_os == 5080){?>
     <td width="20"><div align="center" class="Estilo2">
       <div align="center">N° FORM</div>
     </div></td>
<?php }?>
...
$cod_operacion10=$result10->fields["cod_operacion"]; 
...
}elseif ($nro_practica == 6614){include ("practicas/6614_rast.php");
}elseif ($nro_practica == 373){include ("practicas/373_fecal.php");


}else{
include ("practicas/comun_completas.php");
}
...
<?PHP IF ($nro_os == 5080){?>
  <td height="31" colspan="10" valign="top" bgcolor="#C5C5C5">
      <?php }else{?>
