...
$fecha = $anio_orden."-".$mes_orden."-".$dia_orden;
 ...
 $result = $db->Execute($sql);
    ...
    $sql = "UPDATE ordenes SET `fecha` = '$fecha' , `lote` = '$lote' , `aut_mail` = '$aut_mail' WHERE cod_grabacion = $cod_grabacion";
 $result = $db->Execute($sql);
...
include ("encabezado_validar.php");
include ("practicas_mod_completas_validar.php");
