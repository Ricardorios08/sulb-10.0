...
function verif_caracter(obj,evt)
{
	...
	case "cultivo2":
				...
				document.getElementById("nota").select();
				break;
...
<table width="850" border="0">
        <tr>
          <td height="34" colspan="4" bgcolor="#B8B8B8"><div align="center">EXUDADO URETRAL </div></td>
        </tr>
        
	 
        <tr>
          <td width="264" bgcolor="#F0F0F0"><div align="center">Ex&aacute;men en Fresco </div></td>
        ...
        <tr>
          <td bgcolor="#F0F0F0">&nbsp;</td>
          <td colspan="3"><input name="cultivo2" type="text" id="cultivo2" tabindex = "1"  value="<?php echo $cultivo2?>" size="100" maxlength="120" onKeyPress="return verif_caracter(this,event)"></td>
        </tr>
        <tr>
          <td bgcolor="#F0F0F0"><div align="center">Nota</div></td>
          <td colspan="3"><input name="nota" type="text" id="nota" tabindex = "1"  value="<?php echo $nota?>" size="100" maxlength="120"></td>
        </tr>
