...
$apellido=$result->fields["apellido"];
 ...
 $nombre_completo = STRTOUPPER($apellido." ".$nombre1);
...
$pdf->Cell(80,5,$nombre_completo.". Nº: ".$nro_dia,0);
...
$pdf->Cell(15,5,"",0);
$pdf->SetFont($letra,'B',11);
$pdf->Cell(60,5,"Protocolo: ".$cod_grabacion,0);
$pdf->SetX(150);
$pdf->Cell(60,5,"(Edad: ".$edad." años)",0);
$pdf->Ln();
 

 $pdf->SetFont($letra,'',10);

 $sql2="select * from detalle join convenio_practica on (detalle.nro_practica = convenio_practica.cod_practica) where detalle.cod_grabacion = $cod_grabacion and imprimir = 1 and detalle.nro_practica != 1 GROUP BY detalle.nro_practica order by cod_operacion";
...
$nombre_practica=$result111->fields["practica"];
...
$nombre_practica = substr($nombre_practica,0,20);
	...
	$pdf->ln();
$pdf->SetX(10);
$pdf->Cell(10,7,$nro_practica." - ",0,0,'R');
$pdf->Cell(60,7,$nombre_practica,0,0,'L');
$pdf->Cell(5,7,": ",0,0,'L');
$pdf->Cell(70,7,'',1,0,'L');
