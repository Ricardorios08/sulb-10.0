...
$densidad=ucwords(strtolower($result11->fields["densidad"]));
$color=ucwords(strtolower($result11->fields["color"]));
$aspecto=ucwords(strtolower($result11->fields["aspecto"]));
$sedimento=ucwords(strtolower($result11->fields["sedimento"]));
$reaccion=ucwords(strtolower($result11->fields["reaccion"]));
$proteinas=ucwords(strtolower($result11->fields["proteinas"]));
$glucosa=ucwords(strtolower($result11->fields["glucosa"]));
$biliares=ucwords(strtolower($result11->fields["biliares"]));
$cetonicos=ucwords(strtolower($result11->fields["cetonicos"]));
$hemoglobina=ucwords(strtolower($result11->fields["hemoglobina"]));
$epiteliales=ucwords(strtolower($result11->fields["epiteliales"]));

$leucocito=ucwords(strtolower($result11->fields["leucocito"]));
$piocitos=ucwords(strtolower($result11->fields["piocitos"]));
$hematies=ucwords(strtolower($result11->fields["hematies"]));
$cilindros=ucwords(strtolower($result11->fields["cilindros"]));
$mucus=ucwords(strtolower($result11->fields["mucus"]));
$uratos=ucwords(strtolower($result11->fields["uratos"]));
$observaciones_orina =strtoupper($result11->fields["observaciones"]);
$nitritos =ucwords(strtolower($result11->fields["nitritos"]));
...
if ($proteinas == "NO CONTIENE"){$pdf->SetFont('Arial','',10);}ELSE{$pdf->SetFont('Arial','B',10);}
...
if ($glucosa == "NO CONTIENE"){$pdf->SetFont('Arial','',10);}ELSE{$pdf->SetFont('Arial','B',10);}
...
if ($biliares == "NO CONTIENE"){$pdf->SetFont('Arial','',10);}ELSE{$pdf->SetFont('Arial','B',10);}
...
if ($cetonicos == "NO CONTIENE"){$pdf->SetFont('Arial','',10);}ELSE{$pdf->SetFont('Arial','B',10);}
...
if ($hemoglobina == "NO CONTIENE"){$pdf->SetFont('Arial','',10);}ELSE{$pdf->SetFont('Arial','B',10);}
...
if ($nitritos == "NO CONTIENE"){$pdf->SetFont('Arial','',10);}ELSE{$pdf->SetFont('Arial','B',10);}
...
$pdf->SetX(120);
  ...
  $pdf->Cell(60,5,number_format($neutro_cayado,0));
...
$pdf->Cell(60,5,"mm³");
  ...
  $pdf->Cell(60,5,number_format($neutro_segmentado,0));  
  $pdf->SetX(160);
  $pdf->Cell(60,5,"%");
...
$pdf->Cell(60,5,"mm³");
 ...
 // $pdf->Cell(50,5,"MCV FL(M80-99,f91-99)",0);     
  ...
  $pdf->Cell(60,5,number_format($basofilos,0));  
  $pdf->SetX(160);
  $pdf->Cell(60,5,"%");
     if ($formula == "SI"){
$pdf->SetX(185);
...
$pdf->Cell(60,5,"mm³");
  ...
  $pdf->Cell(60,5,number_format($linfocitos,0)); 
  $pdf->SetX(160);
  $pdf->Cell(60,5,"%");
...
$pdf->Cell(40,5,"",0);
  ...
  $pdf->Cell(60,5,number_format($monocitos,0));   
  $pdf->SetX(160);
  $pdf->Cell(60,5,"%");
...
$pdf->Cell(50,6,"Caracteristicas: ",0);
  $pdf->ln();
