...
$pdf->Row(array('','Lim. sup ref. adultos: 35 UI/l','',''));
$pdf->Row(array('','Lim. sup ref. niños:    UI/l','',''));

$pdf->Row(array('Suero -','ALANINA AMINOTRASNFER.(ALT/ALAT/GPT)',$alanina,'UI/l'));
$pdf->Row(array('','Lim. sup ref. adultos: 36 UI/l','',''));
$pdf->Row(array('','Lim. sup ref. niños:    UI/l','',''));

$pdf->Row(array('Suero -','FOSFATASA ALCALINA(FAL) ',$fosfatasa,'UI/l'));
$pdf->Row(array('','Lim. sup ref. adultos: 258 UI/l','',''));
$pdf->Row(array('','Lim. sup ref. niños:    UI/l','',''));
