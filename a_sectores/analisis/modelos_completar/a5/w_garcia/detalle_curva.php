...
$pdf->Cell(50,5,"Glucemia Basal",0);
  ...
  $pdf->Cell(15,5,number_format($basal,0)); 
...
$pdf->Cell(50,5,"Glucemia a los 120 min",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,5,number_format($a120,0)); 
  $pdf->SetFont('Arial','',$tamanio);
...
$pdf->Row(array('Embarazadas','Basal', '= inferior a 140'.' mg/dl'));
$pdf->Row(array('','A los 120 min', '= inferior a 140'.' mg/dl'));
$pdf->Row(array('NOTA:','A los 120 min','140 a 199 mg/dl','Tolerancia a la glucosa alterada'));
