...
$cod_autorizacion=$_POST[aut.$cod_operacion];

/////////////////////////////////////////////////////////////////////
$valor_obtenido = addslashes($valor_obtenido);

if ($nro_os == 5080){
  $sql = "UPDATE detalle_referencia SET `valor` = '$valor_obtenido' , `cod_autorizacion` = '$cod_autorizacion' WHERE cod_operacion = '$cod_operacion'";
...
if ($nro_os == 5080){
  $sql = "UPDATE detalle SET  `cod_autorizacion` = '$cod_autorizacion' WHERE cod_operacion = '$cod_operacion'";
$result = $db->Execute($sql);
}
...
include ("emision_mod_completa.php");
	}
?>