...
function Footer()
{
  ...
  $this->SetX(10);
	    $this->Cell(200,5,"Av. Libertad 637 - (frente Banco Santander) Villa Nueva - Gllen - Mendoza - TEL: (0261)4211081 - CEL. (0261)5097706",0,0,'C');
...
$pdf->SetY(35);
$pdf->SetX(45);
$pdf->Cell(50,5,'LABORATORIO DE ANÁLISIS CLÍNICOS');
$pdf->ln();
...
$pdf->SetX(20);
$pdf->Cell(50,5,'Pac: '.$nombre_completo1);
$pdf->ln();

$pdf->SetX(20);
$pdf->Cell(50,5,'Dr: '.$nombre_medico);
