...
$pdf->ln();
$pdf->Cell(200,10,'De Análisis Clínicos',0,0,'C');
...
exit;
  ...
  $nombre_completo1 = $apellido." ".$nombre1;
    ...
    $mail_lab="informes@laboratoriobellsar.com";
    //------------------------------
    ...
    $mail->AddAttachment($archivo_fijo);
    //*****Datos del servidor SMTP para hacer posible el envio del correo*****
  $mail->IsSMTP(); 
    $mail->Host = "fa000651.ferozo.com"; //Servidor de Salida.
    $mail->SMTPAuth = true; 
    $mail->Username = "informes@laboratoriosegura.com.ar"; //Correo Electrónico
    $mail->Password = "dZ/c0mc7uB"; //Contraseña
	$mail->ConfirmReadingTo = "bios.segura@gmail.com";
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "laboratoriobellsar@yahoo.com.ar"; //Correo Electrónico
    $mail->Password = "Rivadavia412"; //Contraseña
*/
