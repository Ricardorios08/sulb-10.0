...
switch ($renglon1_4){
case "1":{
$pdf->Cell(70,5,$renglon1);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor1);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon1_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon1);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor1,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon1_2);
break;}
...
switch ($renglon2_4){
case "1":{
$pdf->Cell(70,5,$renglon2);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor2);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon2_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon2);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor2,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon2_2);
break;}
...
switch ($renglon3_4){
case "1":{
$pdf->Cell(70,5,$renglon3);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor3);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon3_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon3);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor3,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon3_2);
break;}
...
switch ($renglon4_4){
case "1":{
$pdf->Cell(70,5,$renglon4);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor4);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon4_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon4);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor4,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon4_2);
break;}
...
switch ($renglon5_4){
case "1":{
$pdf->Cell(70,5,$renglon5);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor5);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon5_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon5);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor5,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon5_2);
break;}
...
switch ($renglon6_4){
case "1":{
$pdf->Cell(70,5,$renglon6);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor6);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon6_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon6);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor6,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon6_2);
break;}
...
switch ($renglon7_4){
case "1":{
$pdf->Cell(70,5,$renglon7);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor7);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon7_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon7);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor7,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon7_2);
break;}
...
switch ($renglon8_4){
case "1":{
$pdf->Cell(70,5,$renglon8);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor8);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon8_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon8);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor8,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon8_2);
break;}
...
switch ($renglon9_4){
case "1":{
$pdf->Cell(70,5,$renglon9);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor9);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon9_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon9);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor9,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon9_2);
break;}
...
switch ($renglon10_4){
case "1":{
$pdf->Cell(70,5,$renglon10);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor10);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon10_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon10);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor10,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon10_2);
break;}
...
switch ($renglon11_4){
case "1":{
$pdf->Cell(70,5,$renglon11);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor11);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon11_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon11);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor11,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon11_2);
break;}
...
switch ($renglon12_4){
case "1":{
$pdf->Cell(70,5,$renglon12);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor12);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon12_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon12);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor12,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon12_2);
break;}
...
switch ($renglon13_4){
case "1":{
$pdf->Cell(70,5,$renglon13);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor13);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon13_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon13);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor13,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon13_2);
break;}
...
switch ($renglon14_4){
case "1":{
$pdf->Cell(70,5,$renglon14);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor14);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon14_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon14);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor14,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon14_2);
break;}
...
switch ($renglon15_4){
case "1":{
$pdf->Cell(70,5,$renglon15);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor15);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon15_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon15);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor15,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon15_2);
break;}
...
switch ($renglon16_4){
case "1":{
$pdf->Cell(70,5,$renglon16);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,$valor16);
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon16_2);
break;}
case "2":{$pdf->Cell(70,5,$renglon16);
$pdf->SetFont($letra,'B',10);
$pdf->Cell(20,5,number_format($valor16,2));
$pdf->SetFont($letra,'',10);
$pdf->Cell(20,5,$renglon16_2);
break;}
