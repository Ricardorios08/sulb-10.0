...
function Footer()
{
  ...
  $this->SetX(10);
	    $this->Cell(200,5,"LAVALLE 256 - GODOY CRUZ - Whatsapp: 261 509 7706",0,0,'C');
...
$pdf->Cell(200,5,utf8_decode('Bioqumica: Sandra Segura'),0,0,'C');
$pdf->ln();
$pdf->Cell(200,5,utf8_decode('Matricula: 1459'),0,0,'C');
//$pdf->ln();
...
$a = utf8_decode('Centro Médico Vitalis');
$pdf->Cell(200,10,$a,0,0,'C');
