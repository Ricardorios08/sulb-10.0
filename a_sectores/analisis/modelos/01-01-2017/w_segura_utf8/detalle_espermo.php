...
$licuacion=utf8_decode($result11->fields["licuacion"]);
$directo=utf8_decode($result11->fields["directo"]);
$citomorfologico=utf8_decode($result11->fields["citomorfologico"]);
$espermios_ml=utf8_decode($result11->fields["espermios_ml"]);
$espermios_vol_eyaculado=utf8_decode($result11->fields["espermios_vol_eyaculado"]); 
$espermios_ovales=utf8_decode($result11->fields["espermios_ovales"]);
$megaloespermas=utf8_decode($result11->fields["megaloespermas"]);
$piriformes=utf8_decode($result11->fields["piriformes"]);
$microespermas=utf8_decode($result11->fields["microespermas"]);
$celulas_duplicadas=utf8_decode($result11->fields["celulas_duplicadas"]);
$amorfo=utf8_decode($result11->fields["amorfo"]);
$leucocitos=utf8_decode($result11->fields["leucocitos"]);
$piocitos=utf8_decode($result11->fields["piocitos"]);
$celulas_planas=utf8_decode($result11->fields["celulas_planas"]);
$conglomerado_espermios=utf8_decode($result11->fields["conglomerado_espermios"]); 
$motilidad=utf8_decode($result11->fields["motilidad"]);
$formas_moviles=utf8_decode($result11->fields["formas_moviles"]);
$formas_inmoviles=utf8_decode($result11->fields["formas_inmoviles"]);
$tipo_movilidad=utf8_decode($result11->fields["tipo_movilidad"]);
$desplazamiento_rapido=utf8_decode($result11->fields["desplazamiento_rapido"]);
$desplazamiento_lento=utf8_decode($result11->fields["desplazamiento_lento"]);
$desplazamiento_muy_lento=utf8_decode($result11->fields["desplazamiento_muy_lento"]);
$eosina_negativa=utf8_decode($result11->fields["eosina_negativa"]);
$eosina_positiva=utf8_decode($result11->fields["eosina_positiva"]);
$metileno=utf8_decode($result11->fields["metileno"]); 
$fructosa=utf8_decode($result11->fields["fructosa"]);
$citrico=utf8_decode($result11->fields["citrico"]);

$ascorbico=utf8_decode($result11->fields["ascorbico"]);
$ascorbicos_analogos=utf8_decode($result11->fields["ascorbicos_analogos"]);
$analogos=utf8_decode($result11->fields["analogos"]);
$real=utf8_decode($result11->fields["real"]);
$fosfatasa=utf8_decode($result11->fields["fosfatasa"]);
$glicerilfosforilcolina=utf8_decode($result11->fields["glicerilfosforilcolina"]);
$otros_elementos=utf8_decode($result11->fields["otros_elementos"]);
