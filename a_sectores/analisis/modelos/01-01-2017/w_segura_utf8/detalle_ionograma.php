...
$natremia=utf8_decode(strtoupper($result11->fields["natremia"]));
$kalemia=utf8_decode(strtoupper($result11->fields["kalemia"]));
$cloremia =utf8_decode(strtoupper($result11->fields["cloremia"]));
