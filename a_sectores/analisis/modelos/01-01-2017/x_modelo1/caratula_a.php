...
$pdf->setRenglon($renglon4);
$pdf->setRenglon2($renglon5);
...
//$logo_seleccionado = "logo_rosales.jpg";


$pdf->SetY(20);
$pdf->Image($logo_seleccionado,25,15,25);
...
$pdf->Cell(200,5,"Bioquímicos",0,1,'C');
...
$nombre_completo1 =substr($nombre_completo1,0,33);
...
$pdf->SetWidths(array(70,95));

srand(microtime()*1000000);
$pdf->SetX(35);
$pdf->Row(array('Paciente: ',$nombre_completo1));
$pdf->SetX(35);
$pdf->Row(array('Profesional Solicitante: ',$nombre_medico));
$pdf->SetX(35);
$pdf->Row(array('Fecha: ',$fecha_mostrar));
...
$pdf->Cell(180,5,$renglon4,0,1,'R');

$pdf->Cell(180,5,$renglon5,0,1,'R');
