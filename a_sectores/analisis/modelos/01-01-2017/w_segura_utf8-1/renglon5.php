...
//$pdf->Cell(80,5,$renglon5." ".$valor5." ".$renglon5_2,0,0,L);
 $pdf->SetX(37);$pdf->Cell(45,5,$renglon5,0,0,C);
 $pdf->SetFont($letra,'B',10);
$pdf->Cell(45,5,$valor5." ".$renglon5_2,0,0,L,TRUE);$pdf->SetFont($letra,'',10);
break;}
case "4":{
 $pdf->SetFont($letra,$renglon_tipo_letra_5,9);
	$pdf->Cell(80,5,$renglon5." ".'',0,0,L);break;}
case "5":{include("cambiar_color.php");$pdf->Cell(160,5,$renglon5,0,0,'C',true);include("cambiar_color_normal.php");break;}
case "6":{$pdf->Cell(80,5,$renglon5." ".$valor5." ".$renglon5_2,0,0,L);break;}
}
