...
$this->setx(100);
$this->Cell(40,5,utf8_decode('N° Protocolo: ').$this->getPaciente());
$this->setx(163);
...
function Footer()
{
  ...
  $this->SetX(10);
	    $this->Cell(200,5,"Av. Libertad 637 - (frente Banco Santander) Villa Nueva - Gllen - Mendoza - TEL: (0261)3951370 - CEL. (0261)5097706",0,0,'C');
...
$pdf->SetY(10);
$pdf->Cell(200,5,utf8_decode('Bioquímica: Sandra Segura'), 0,0,'C');
$pdf->ln();
...
$pdf->ln();
$pdf->Cell(200,10,utf8_decode('De Análisis Clínicos'),0,0,'C');
...
$pdf->SetX(20);
$pdf->Cell(50,5,'Solicitado por Dr/a: '.$nombre_medico);
