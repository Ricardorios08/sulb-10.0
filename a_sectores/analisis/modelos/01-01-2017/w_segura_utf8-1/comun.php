...
$result111 = $db->Execute($sql111);
 ...
 $valor=utf8_decode($result111->fields["valor"]);
 $valor1=utf8_decode($result111->fields["valor"]);
$referencia=utf8_decode($result111->fields["referencia"]);
$referencia1=utf8_decode($result111->fields["referencia1"]);
$referencia2=utf8_decode($result111->fields["referencia2"]);
$referencia3=utf8_decode($result111->fields["referencia3"]);

$rin=utf8_decode($result111->fields["rin"]);
$porcentaje=utf8_decode($result111->fields["porcentaje"]);

if (($porcentaje == 0 ) or ($porcentaje == 0.00)){
$porcentaje = "";
}
$observaciones=utf8_decode($result111->fields["observaciones"]);
...
$saturacion = round(($hierro_reservado / $valor)* 100);
...
$salto=utf8_decode($result111->fields["salto"]);
...
$metodo=utf8_decode($result111->fields["metodo"]);
//$metodo = nl2br( stripslashes( htmlentities($metodo))));

$det = substr($nombre_practica,0,22);

$tipo_det=utf8_decode($result111->fields["tipo_det"]);
