...
$suero=utf8_decode(strtoupper($result11->fields["suero"]));
$quilomicrones=utf8_decode(strtoupper($result11->fields["quilomicrones"]));
$beta=utf8_decode(strtoupper($result11->fields["beta"]));
$prebeta=utf8_decode(strtoupper($result11->fields["prebeta"]));
$alfa=utf8_decode(strtoupper($result11->fields["alfa"]));
