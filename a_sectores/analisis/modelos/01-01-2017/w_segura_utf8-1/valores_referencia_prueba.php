...
/*
if ($nro_practica != 9041){

if (($desde == "Hasta") or ($hasta == "")){
$desde = "";
$hasta = "";
}
...
if (($desde > 0) and ($hasta > 0)){
	if ($nro_practica == '192000'){
$pdf->Row(array("V.R: ".$columna1." Mayor de ".$desde.'  '.$hasta.'  '.$unidad." ".$columna2));
	}else{
$pdf->Row(array("V.R: ".$columna1." ".$desde.'  '.$hasta.'  '.$unidad." ".$columna2));
...
$sql11="select * from convenio_referencia where cod_practica =  $nro_practica and nro_ref = $nro_ref and tipo like '$sexo'";
$result11 = $db->Execute($sql11);
