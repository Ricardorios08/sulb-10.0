...
$hematies=utf8_decode(number_format($result11->fields["hematies"], 0, ',', '.'));
$hemoglobina=utf8_decode(number_format($result11->fields["hemoglobina"], 2, ',', '.'));
$reticulocitos=utf8_decode(number_format($result11->fields["reticulocitos"], 0, ',', '.'));
...
$reticulocitos=utf8_decode($result11->fields["reticulocitos"]);
$plaquetas=utf8_decode($result11->fields["plaquetas"]);

*/


$hematocrito=utf8_decode(round($result11->fields["hematocrito"],2));


$mcv=utf8_decode(number_format($result11->fields["mcv"],2));
$mch=utf8_decode(number_format($result11->fields["mch"],2));
$mchc=utf8_decode(number_format($result11->fields["mchc"],2));

$neutro_cayado=utf8_decode($result11->fields["neutro_cayado"]);
$neutro_segmentado=utf8_decode($result11->fields["neutro_segmentado"]);
$eosinofilos=utf8_decode($result11->fields["eosinofilos"]);
$basofilos=utf8_decode($result11->fields["basofilos"]);
$linfocitos=utf8_decode($result11->fields["linfocitos"]);
$monocitos=utf8_decode($result11->fields["monocitos"]);



$carac_plaquetas=utf8_decode($result11->fields["carac_plaquetas"]);
$carac_leucocitos=utf8_decode($result11->fields["carac_leucocitos"]);
$carac_hematies=utf8_decode($result11->fields["carac_hematies"]);
$carac_hematies2=utf8_decode($result11->fields["carac_hematies2"]);


$observaciones =utf8_decode($result11->fields["observaciones"]);
$formula =utf8_decode(strtoupper($result11->fields["formula"]));
...
$leucocitos=utf8_decode(number_format($result11->fields["leucocitos"], 0, ',', '.'));
...
if ($mchc > 0){
$pdf->Ln();$pdf->SetX(30);
		 $pdf->Cell(35,5,"MCHC (MyF 30-35) ",0); 
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,5,$mchc,0);   
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,5," g/dl",0);
}
