...
function Footer()
{
  ...
  $this->SetX(10);
  $direccion = utf8_decode("Guiñazu 375 - 1° Piso - Edificio Tours Sauvignon Amamanecer - Lujan de Cuyo - Cel: (0261) 155 097706",);
	    $this->Cell(200,5,$direccion0,0,'C');
...
$pdf->SetY(10);
$a = utf8_decode('Bioquímica: Sandra Segura',);
$pdf->Cell(200,5,$a,0,0,'C');
$pdf->ln();
$a = utf8_decode('Matrícula: 1459');
$pdf->Cell(200,5,$a,0,0,'C');
