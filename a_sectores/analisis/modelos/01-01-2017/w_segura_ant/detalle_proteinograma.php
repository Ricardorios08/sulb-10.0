...
$todo = $unidad.$vr.$unidad;
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(40,5,"Beta 1 Globulina",0);     
$pdf->SetFont($letra,'B',$tamanio);
...
$todo = $unidad.$vr.$unidad;
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(40,5,"Beta 2 Globulina",0);     
$pdf->SetFont($letra,'B',$tamanio);
$pdf->Cell(12,5,$beta2,0);
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(10,5,$unidad,0); 
$pdf->Cell(45,5,$vr,0);
$pdf->ln();
...
$todo = $unidad.$vr.$unidad;
	...
	if (($albumina == "") or ($albumina == 0)){
$leyenda = "Debe cargar la Albumina para poder continuar";
include ("../../../alertas/campo_informacion2.php");
exit;
	}


	if (($globulina == "") or ($globulina == 0)){
$leyenda = "Debe cargar la Globulina para poder continuar";
include ("../../../alertas/campo_informacion2.php");
exit;
	}
