...
$pdf->Cell(190,10,'Clínica MONTES',0,1,'C');

$pdf->SetFont($letra,'B',12);


$pdf->Cell(190,10,"Dr. Nicolás Allendes – Dr. Mario Casé",0,1,'C');
...
$pdf->SetFont('Arial','',9);
 $pdf->Cell(190,5,"Montecaseros 1447 - Ciudad - Mendoza - Tel: 420-3139",0,1,'C');
 $pdf->Ln();
