...
$mcv=$result11->fields["mcv"];
$mch=$result11->fields["mch"];
$mchc=$result11->fields["mchc"];
...
*/
 ...
 if ($mcv > 0){
  $pdf->Cell(40,5,"MCV fl (M80-99.F91-99): ",0); 
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,5,$mcv,0);   
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,5," Fl",0);
...
if ($mch > 0){
$pdf->ln();
  $pdf->Cell(40,5,"MCH pg(MyF 27-31): ",0); 
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,5,$mch,0);   
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,5,"Fl",0);
...
$pdf->Cell(35,6,"Leucocitos: ",0);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(60,6,$carac_leucocitos,0); 
$pdf->SetFont('Arial','',$tamanio);
 
$pdf->ln();
$pdf->Cell(35,6,"Hematíes: ",0);
$pdf->SetFont('Arial','B',$tamanio);
