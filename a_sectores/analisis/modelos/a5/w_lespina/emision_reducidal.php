...
function Footer()
{
  ...
  $this->Image('../../../logos/'.$v,143,130,10);
  
  $this->Cell(0,10,"URQUIZA 1860 - COQUIMBITO - MAIPU - Tel: (0261)481-0457 /  Cel.: 155-380174                          Whatsapp(261)5380174",0,0,'C');
$this->ln();
		$this->Cell(0,5,"mariana_lespina@yahoo.com.ar",0,0,'C');
}
...
$v = "logo_lespina.jpg";
$pdf->SetY(20);
  $pdf->Image('../../../logos/'.$v,25,20,80);

$pdf->SetY(30);

$pdf->SetFont('ARIAL','B',14);
$pdf->Cell(280,5,'DRA. MARIANA LESPINA',0,1,'C');


$pdf->SetFont('ARIAL','B',10);
$pdf->Cell(280,5,'Bioquìmica Mat.: 1053',0,1,'C');
