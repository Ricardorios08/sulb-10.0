...
$pdf->Row(array('Dieta poore en calcio: ','5.00 a 40.00','ml',$referencia3));
$pdf->Row(array('Dieta media: ','50.00 a 150.00','ml',$referencia3));
$pdf->Row(array('Dieta rica en calcio: ','100.00 a 300.00','ml',$referencia3));
