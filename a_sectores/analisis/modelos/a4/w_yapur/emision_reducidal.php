...
$this->Cell(200,5,'LABORATORIO DE BIOQUÍMICA CLÍNICA',0,0,C);
$this->setY(10);
$this->setx(10);
$this->SetFont('Times','BI',12);
$this->Cell(200,5,'Análisis Clínicos – Bacteriológicos – Monitoreo de Drogas – Hormonas',0,0,C);
...
$this->Cell(200,5,'Dr. Gustavo Yapur',0,0,C);
...
$this->setY(35);
$this->setx(15);
$this->Cell(40,5,'Apellido y nombre: '.$this->getNombre());
...
$this->setx(120);
$this->Cell(40,5,'Institución: '.$this->getInstitucion());
...
$ren1 = "Lisandro de la Torre 205 (Esq. J. Barraquero) - Mendoza ";
$ren2 = "Tel.: 424-0060 / 424-6020  Cel: 155-093424";
...
$pdf->Cell(190,10,'DR. GUSTAVO YAPUR',0,1,'C');
$pdf->SetFont('Arial','',9);
...
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(200,5,"Lisandro de la Torre 205 - Esq. Julian Barraquero - Ciudad",0,0,C);

$pdf->Ln();
$pdf->Cell(200,5,"Tel: 424-0060 Cel: (2615)-093424",0,0,C);
 /*
$pdf->SetFont('Arial','B',9);
