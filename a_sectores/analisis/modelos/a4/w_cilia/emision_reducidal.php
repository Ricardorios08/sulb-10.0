...
$this->ln();
$this->setx(10);
$this->Cell(40,5,'Medico: '.$this->getAfiliado());
$this->ln();
...
$a = "lac_firma.jpg";
  ...
  $this->Image('../../../logos/'.$a,140,245,60);
$this->line(10,270,200,270);
//$this->line(158,130,200,130);
$this->Cell(0,5,'Luis Correas 177',0,0,'L');
$this->SetX(90);
$this->Cell(0,5,'Tel: (0263)449-1015',0,0,'L');
$this->SetX(170);
$this->Cell(0,5,'Medrano - Mendoza',0,0,'L');
 $this->ln();
...
$domicilio_paciente = $direccion." - ".$localidad." - ".$telefono;
...
$pdf->SetX(40);
$pdf->Cell(190,10,"Dr. JUAN MANUEL ARAMBURO",0,1,'C');

//$pdf->Cell(190,10,'FLORIDA SALUD',0,1,'C');
...
$pdf->SetWidths(array(28,85,30,90));
