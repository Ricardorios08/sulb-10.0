...
$pdf->Cell(50,10,"EXAMEN MACROSCOPICO",0);  
$pdf->ln();
$pdf->Cell(40,10,$metodo_macro,0); 
$pdf->ln();

 
$pdf->Cell(90,10,$resultado_macro,0); 

$pdf->ln();



$pdf->Cell(50,10,"EXAMEN MICROSCOPICO",0);
$pdf->ln();
$pdf->Cell(40,10,$metodo_micro,0);     
$pdf->ln();

 
$pdf->Cell(50,10,$resultado_micro,0);  

$pdf->ln();


 
$pdf->Cell(40,10,$resultado_micro1,0);     
$pdf->ln();
...
$pdf->Cell(60,10,$observaciones_fecal,0);     
$pdf->ln();
