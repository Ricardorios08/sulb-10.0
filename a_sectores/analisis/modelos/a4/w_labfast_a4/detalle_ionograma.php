...
$pdf->Cell(10,10,$natremia,0); 
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(10,10,"mmol/l",0);  
$pdf->ln();
  $pdf->SetFont($letra,'',9);
$pdf->Cell(60,10,"V.R:  de 135 a 145 mmol/l",0);     
$pdf->ln();
$pdf->ln();
...
$pdf->Cell(10,10,$kalemia,0);  
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(10,10,"mmol/l",0);  
$pdf->ln();
 $pdf->SetFont($letra,'',9); 
$pdf->Cell(60,10,"V.R:  de 3.5 a 5.3 mmol/l",0);     
$pdf->ln();
$pdf->ln();
...
$pdf->Cell(10,10,$cloremia,0);  
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(10,10,"mmol/l",0);  
$pdf->ln();
$pdf->SetFont($letra,'',9);
 
$pdf->Cell(60,10,"V.R:  de 94 a 111 mmol/l",0);     
}
