...
$pdf->Cell(50,10,"Dosis administrada: 75 g. de glucosa anhidra",0);     
$pdf->ln();
...
$pdf->Cell(50,10,"Glucemia Basal",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,$basal); 
  $pdf->SetFont('Arial','',$tamanio);

  $pdf->Cell(20,10,"mg/dl");

if ($a30 > 0){
$pdf->ln();
$pdf->Cell(50,10,"Glucemia a los 30 min",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,number_format($a30,0)); 
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,10,"mg/dl");
}
...
if ($a60 > 0){
$pdf->ln();
$pdf->Cell(50,10,"Glucemia a los 60 min",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,number_format($a60,0)); 
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,10,"mg/dl");
}

   $pdf->ln();
$pdf->Cell(50,10,"Glucemia a los 120 min",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,$a120); 
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,10,"mg/dl");
...
$pdf->Cell(50,10,"Glucemia a los 60 min",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,number_format($a180,0)); 
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,10,"mg/dl");
}
...
$pdf->ln();
$pdf->Cell(50,10,"En embarazadas, valores superiores alos indicados sugieren Diabetes gestacional",0);     
