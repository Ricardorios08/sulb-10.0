...
$pdf->Cell(70,10,"Sensible a:",0);  
$pdf->Cell(70,10,"Medianamente sensible a:",0);  
$pdf->Cell(70,10,"Resistente a:",0);  
 

   $pdf->SetFont('Arial','B',$tamanio);

$pdf->ln();
$pdf->Cell(70,10,$sensible1,0); 

$pdf->Cell(70,10,$med_sensible1,0); 
$pdf->Cell(70,10,$resistente1,0); 
$pdf->ln();

$pdf->Cell(70,10,$sensible2,0); 
$pdf->Cell(70,10,$med_sensible2,0); 
$pdf->Cell(70,10,$resistente2,0); 
$pdf->ln();

$pdf->Cell(70,10,$sensible3,0); 
$pdf->Cell(70,10,$med_sensible3,0); 
$pdf->Cell(70,10,$resistente3,0); 
$pdf->ln();
 
$pdf->Cell(70,10,$sensible4,0); 
$pdf->Cell(70,10,$med_sensible4,0); 
$pdf->Cell(70,10,$resistente4,0); 
$pdf->ln();

$pdf->Cell(70,10,$sensible5,0); 
$pdf->Cell(70,10,$med_sensible5,0); 
$pdf->Cell(70,10,$resistente5,0); 
$pdf->ln();

$pdf->Cell(70,10,$sensible6,0); 
$pdf->Cell(70,10,$med_sensible6,0); 
$pdf->Cell(70,10,$resistente6,0); 
$pdf->ln();
