...
$pdf->Ln();
$pdf->SetX(126);
  $pdf->Cell(50,10,"FORMULA LEUCOCITARIA",0);
...
$pdf->ln();
  ...
  $pdf->Cell(35,10,"Hematíes: ",0);   
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,10,$hematies,0); 
 $pdf->SetFont('Arial','',$tamanio);
  $pdf->Cell(20,10," / mm³",0); 



  $pdf->Cell(50,10,"Neutrófilos en cayado: ",0);
$pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(20,10,number_format($neutro_cayado,0));
 $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(137);
  $pdf->Cell(20,10,"%");
...
$pdf->Cell(60,10,$absoluto_neutro_cayado);
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(177);
$pdf->Cell(60,10,"/ mm³");
}
  ...
  /////////////////////////////
  $pdf->Cell(35,10,"Hemoglobina: ",0);   
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,10,$hemoglobina,0);  
  $pdf->SetFont('Arial','',$tamanio);
 $pdf->Cell(20,10,"gr % ml",0); 


$pdf->Cell(50,10,"Neutrófilos segmentado: ",0);
  $pdf->SetFont('Arial','B',$tamanio);

  $pdf->Cell(20,10,number_format($neutro_segmentado,0)); 
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(137);
  $pdf->Cell(20,10,"%");
...
$pdf->Cell(60,10,$absoluto_neutro_segmentado);
$pdf->SetX(177);
  $pdf->SetFont('Arial','',$tamanio);
$pdf->Cell(20,10,"/ mm³");
}
  ...
  /////////////////////////////
  $pdf->Cell(35,10,"Hematocrito: ",0);  
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,10,$hematocrito,0);   
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,10,"%",0); 
  

$pdf->Cell(50,10,"Eosinofilos: ",0);
      
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(60,10,number_format($eosinofilos,0), 0, ',', '.');    
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(137);
  $pdf->Cell(60,10,"%");
...
$pdf->Cell(60,10,$absoluto_eosinofilos);
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(177);
$pdf->Cell(60,10,"/ mm³");
}
  ...
  $pdf->Ln(); //Esto hace un cambio de línea 
    ...
    $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(35,10,"Leucocitos: ",0);


    $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,10,$leucocitos);  

 $pdf->SetFont('Arial','',$tamanio);
	$pdf->Cell(20,10," / mm³",0); 
  
$pdf->Cell(50,10,"Basófilos: ",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,number_format($basofilos,0));  
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(137);
  $pdf->Cell(20,10,"%");
     if ($formula == "SI"){
...
$pdf->Cell(60,10,$absoluto_basofilos);
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(177);
$pdf->Cell(60,10,"/ mm³");
}
...
{
  $pdf->Cell(35,10,"Reticulocitos: ",0);   
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,10,$reticulocitos,0); 
  $pdf->SetFont('Arial','',$tamanio);
      $pdf->Cell(20,10," / mm³",0); 
}
  
$pdf->Cell(50,10,"Linfocitos: ",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,number_format($linfocitos,0)); 
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(137);
  $pdf->Cell(20,10,"%");
...
$pdf->Cell(60,10,$absoluto_linfocitos);
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(177);
$pdf->Cell(60,10,"/ mm³");
}
...
{
  $pdf->Cell(35,10,"Plaquetas: ",0); 
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(17,10,$plaquetas,0);   
  $pdf->SetFont('Arial','',$tamanio);
   $pdf->Cell(20,10," / mm³",0);


}
$pdf->Cell(50,10,"Monocitos: ",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,10,number_format($monocitos,0)); 
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(137);
  $pdf->Cell(20,10,"%");
...
$pdf->Cell(60,10,$absoluto_monocitos);
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(177);
$pdf->Cell(60,10,"/ mm³");
}
...
/*$pdf->SetX(145);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(60,10,$total_leucocitos);
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(160);
$pdf->Cell(20,10,"%");
...
$pdf->SetX(185);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(60,10,number_format($total_absoluto_leucocitos));
$pdf->SetFont('Arial','',$tamanio);
$pdf->SetX(195);
$pdf->Cell(60,10,"/ mm³");
}
...
$pdf->Cell(35,10,"Alteraciones Cualitativas: ",0);
  $pdf->ln();

  $pdf->SetFont('Arial','',$tamanio);
$pdf->Cell(35,10,"Plaquetas: ",0);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(35,10,$carac_plaquetas,0); 
$pdf->SetFont('Arial','',$tamanio);
...
$pdf->Cell(35,10,"Leucocitos: ",0);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(60,10,$carac_leucocitos,0); 
$pdf->SetFont('Arial','',$tamanio);
 
$pdf->ln();
$pdf->Cell(35,10,"Hematíes: ",0);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(60,10,$carac_hematies,0); 
$pdf->SetFont('Arial','',$tamanio);
$pdf->Ln();
$pdf->Cell(50,10,"",0);
$pdf->SetFont('Arial','B',$tamanio);
$pdf->Cell(60,10,$carac_hematies2,0); 
$pdf->SetFont('Arial','',$tamanio);
