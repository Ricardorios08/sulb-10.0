...
$pdf->Cell(40,10,'PROTEINAS FRACCIONADAS');
...
$pdf->Cell(50,10,"PROTIDEMIA",0);     
$pdf->Cell(50,10,$diuresis,0);  
$pdf->Cell(50,10,"l",0);  
$pdf->ln();

$pdf->Cell(50,10,"V. Hallado: ",0);     
$pdf->Cell(50,10,$valor_hallado,0);  
$pdf->Cell(50,10,"g/dl",0);  
$pdf->ln();
$pdf->Cell(50,10,"VN: 6.10 A 8.00 G/DL",0);  
$pdf->ln();
