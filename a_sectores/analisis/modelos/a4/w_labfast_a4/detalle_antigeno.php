...
$pdf->Cell(50,10,$enzima,0);  
$pdf->Cell(50,10,"ng/ml",0);  
$pdf->ln();
...
$pdf->Cell(50,10,"Met. Elisa",0);   
 
$pdf->ln();

$pdf->Cell(50,10,"Resultado",0);     
$pdf->Cell(50,10,$elisa,0);  
$pdf->Cell(50,10,"ng/ml",0);  
$pdf->ln();

$pdf->Cell(50,10,"Razón Porcentual:",0);     
$pdf->Cell(50,10,$razon_porcentual,0);  
$pdf->Cell(50,10,"ng/ml",0);  
