...
$pdf->Cell(50,10,"Muestra y obtención:",0);     
$pdf->Cell(50,10,$muestra,0);  

$pdf->ln();
$pdf->ln();
$pdf->Cell(50,10,"Color: ",0);     
$pdf->Cell(50,10,$color,0);  
$pdf->Cell(30,10,"Aspecto:",0);  
$pdf->Cell(50,10,$aspecto,0);  
$pdf->ln();
$pdf->ln();

$pdf->Cell(50,10,"OBSERVACION MICROSCOPICA:",0);  
$pdf->ln();
$pdf->ln();
$pdf->Cell(50,10,"EN FRESCO: ",0);  
$pdf->ln();

$pdf->Cell(150,10,$obs_micro,0);  


$pdf->ln();
$pdf->Cell(50,10,"CON COLORACION DE GRAM-NICOLLE:",0);  
$pdf->ln();
$pdf->ln();
$pdf->Cell(150,10,$nicolle,0);  


$pdf->Ln();
$pdf->ln();
$pdf->Cell(50,10,"CULTIVO E IDENTIFICACION",0);  
$pdf->ln();
$pdf->ln();
$pdf->Cell(150,10,$cultivo,0);  
