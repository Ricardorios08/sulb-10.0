...
$pdf->SetX(150); 
$valor1 = '"'.$valor1.'"';
$pdf->Cell(100,10,$valor1);
 $pdf->ln(); 
$pdf->SetX(150); 

$pdf->Cell(100,10,$valor2);
 $pdf->ln(); 
$pdf->SetX(150); 

$pdf->Cell(100,5,$fecha_mostrar);

 $pdf->ln(); 

$pdf->SetY(33); 
$pdf->SetX(30); 
$pdf->Cell(60,5,$nombre_completo1);

 $pdf->ln(); 
 $pdf->SetX(30); 
$pdf->Cell(100,5,$domicilio_paciente);
