...
$a = "labfast.jpg";
 $this->Image('../../../logos/'.$a,145,128,62);
$this->line(10,130,150,130);
$this->line(158,130,200,130);
    $this->Cell(0,5,' DORREGO 1003 - DORREGO - MENDOZA - TEL: (0261) 4320870  Cel.: (261)-5598824',0,0,'L');
 $this->ln();
	    $this->Cell(0,5,'jmaramburo@hotmail.com '.$this->PageNo(),0,0,'L');
}
