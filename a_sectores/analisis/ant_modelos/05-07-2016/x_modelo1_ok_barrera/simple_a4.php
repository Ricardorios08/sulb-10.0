...
if (($banderin == 1) and ($clase == 1)){
	$pdf->AddPage();

}

if (($banderin == 1) and ($clase == 2)){

	$pdf->AddPage();
}

if (($banderin == 1) and ($clase == 3)){
	$pdf->AddPage();
}

if (($banderin == 1) and ($clase == 4)){
	$pdf->AddPage();
}
...
switch ($clase){
case "0":{include ("comun_a4.php");break;}
case "1":{include ("complejos_a4.php"); $marca = "comple";  break;}
