...
$hematocrito=round($result11->fields["hematocrito"],2);
...
$tamanio = 11;
$pdf->SetFont('Times','BIU',$tamanio);
$pdf->Cell(40,10,$nombre_practica);
$tamanio = 9;
$pdf->SetFont('Times','',$tamanio);



$pdf->Ln();
$pdf->SetX(30);
  $pdf->Cell(50,5,"SERIE ROJA",0);
$pdf->SetX(95);
 $pdf->Cell(50,5,"SERIE BLANCA");
 $pdf->SetX(125);
 $pdf->Cell(50,5,"RECUENTO LEUCOCITARIO ");
 
$pdf->SetFont('Times','B',10);

 $pdf->Cell(50,5,$leucocitos." /mm³");
...
$pdf->SetX(145);
$pdf->Cell(40,5,"V. RELATIVO");

if ($formula == "SI"){
	
$pdf->SetX(175);
$pdf->Cell(40,5,"V. ABSOLUTO");
}
...
$pdf->ln();
$pdf->SetX(30);
  $pdf->Cell(50,5,"Recuento de hematíes: ",0);   
  $pdf->SetFont('Times','B',$tamanio);
 ...
 $pdf->SetFont('Times','',$tamanio);
  ...
  $pdf->Cell(50,5,"Neutrófilos en cayado: ",0,0,'L'); 
 


$pdf->SetFont('Times','B',$tamanio);
  $pdf->Cell(10,5,number_format($neutro_cayado,0),0,0,'R');  
 $pdf->SetFont('Times','',$tamanio);
...
$pdf->Cell(15,5,$absoluto_neutro_cayado,0,0,'R');
$pdf->SetFont('Times','',$tamanio);
$pdf->SetX(190);
$pdf->Cell(60,5,"/ mm³");
}
...
$pdf->Cell(50,5,"Neutrófilos segmentado: ",0);
  ...
  $pdf->Cell(10,5,number_format($neutro_segmentado,0),0,0,'R'); 
  $pdf->SetFont('Times','',$tamanio);
...
$pdf->Cell(15,5,$absoluto_neutro_segmentado,0,0,'R');
$pdf->SetX(190);
  $pdf->SetFont('Times','',$tamanio);
$pdf->Cell(20,5,"/ mm³");
}
...
$pdf->Cell(50,5,"Eosinofilos: ",0,0,'L'); 
  
	  
  $pdf->SetFont('Times','B',$tamanio);
  $pdf->Cell(10,5,number_format($eosinofilos,0),0,0,'R');
  $pdf->SetFont('Times','',$tamanio);
...
$pdf->Cell(15,5,$absoluto_eosinofilos,0,0,'R');
$pdf->SetFont('Times','',$tamanio);
$pdf->SetX(190);
$pdf->Cell(60,5,"/ mm³");
}
...
$pdf->Cell(50,5,"Basófilos: ",0,0,'L');
  $pdf->SetFont('Times','B',$tamanio);
  $pdf->Cell(10,5,number_format($basofilos,0),0,0,'R'); 
  $pdf->SetFont('Times','',$tamanio);
...
$pdf->Cell(15,5,$absoluto_basofilos,0,0,'R');
$pdf->SetFont('Times','',$tamanio);
$pdf->SetX(190);
$pdf->Cell(60,5,"/ mm³");
}
...
$pdf->Cell(50,5,"Linfocitos: ",0,0,'L');
  $pdf->SetFont('Times','B',$tamanio);
  $pdf->Cell(10,5,number_format($linfocitos,0),0,0,'R');
  $pdf->SetFont('Times','',$tamanio);
...
$pdf->Cell(15,5,$absoluto_linfocitos,0,0,'R');
$pdf->SetFont('Times','',$tamanio);
$pdf->SetX(190);
$pdf->Cell(60,5,"/ mm³");
}
...
$pdf->Cell(50,5,"Monocitos: ",0,0,'L');
  $pdf->SetFont('Times','B',$tamanio);
  $pdf->Cell(10,5,number_format($monocitos,0),0,0,'R');
  $pdf->SetFont('Times','',$tamanio);
...
$pdf->Cell(15,5,$absoluto_monocitos,0,0,'R');
$pdf->SetFont('Times','',$tamanio);
$pdf->SetX(190);
$pdf->Cell(60,5,"/ mm³");
}
