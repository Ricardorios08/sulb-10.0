...
$pdf->SetX(30);
if (($valor1 != '') and ($renglon1_4 != 4)){
switch ($renglon1_4){
case "1":{$pdf->Cell(60,5,$renglon1." ".$valor1." ".$renglon1_2,0,0,L);break;}
...
if ($valor2 != ''){
switch ($renglon2_4){
case "1":{$pdf->Cell(60,5,$renglon2." ".$valor2." ".$renglon2_2,0,0,L);break;}
...
if ($valor3 != ''){
switch ($renglon3_4){
case "1":{$pdf->Cell(60,5,$renglon3." ".$valor3." ".$renglon3_2,0,0,L);break;}
...
if ($valor4 != ''){
switch ($renglon4_4){
case "1":{$pdf->Cell(60,5,$renglon4." ".$valor4." ".$renglon4_2,0,0,L);break;}
...
if ($valor5 != ''){
switch ($renglon5_4){
case "1":{$pdf->Cell(60,5,$renglon5." ".$valor5." ".$renglon5_2,0,0,L);break;}
...
if ($valor6 != ''){
switch ($renglon6_4){
case "1":{$pdf->Cell(60,5,$renglon6." ".$valor6." ".$renglon6_2,0,0,L);break;}
...
if ($valor7 != ''){
switch ($renglon7_4){
case "1":{$pdf->Cell(60,5,$renglon7." ".$valor7." ".$renglon7_2,0,0,L);break;}
...
if ($valor8 != ''){
switch ($renglon8_4){
case "1":{$pdf->Cell(60,5,$renglon8." ".$valor8." ".$renglon8_2,0,0,L);break;}
...
if ($valor9 != ''){
switch ($renglon9_4){
case "1":{$pdf->Cell(60,5,$renglon9." ".$valor9." ".$renglon9_2,0,0,L);break;}
...
if ($valor10 != ''){
switch ($renglon10_4){
case "1":{$pdf->Cell(60,5,$renglon10." ".$valor10." ".$renglon10_2,0,0,L);break;}
...
if ($valor11 != ''){
switch ($renglon11_4){
case "1":{$pdf->Cell(60,5,$renglon11." ".$valor11." ".$renglon11_2,0,0,L);break;}
...
if ($valor12 != ''){
switch ($renglon12_4){
case "1":{$pdf->Cell(60,5,$renglon12." ".$valor12." ".$renglon12_2,0,0,L);break;}
...
if ($valor13 != ''){
switch ($renglon13_4){
case "1":{$pdf->Cell(60,5,$renglon13." ".$valor13." ".$renglon13_2,0,0,L);break;}
...
if ($valor14 != ''){
switch ($renglon14_4){
case "1":{$pdf->Cell(60,5,$renglon14." ".$valor14." ".$renglon14_2,0,0,L);break;}
...
if ($valor15 != ''){
switch ($renglon15_4){
case "1":{$pdf->Cell(60,5,$renglon15." ".$valor15." ".$renglon15_2,0,0,L);break;}
...
if ($valor16 != ''){
switch ($renglon16_4){
case "1":{$pdf->Cell(60,5,$renglon16." ".$valor16." ".$renglon16_2,0,0,L);break;}
