...
include ("../../conexiones/config.inc.php");
$sql="Delete From convenio_referencia where cod_operacion = $cod_operacion";
$db->Execute($sql);
}
...
include ("../../conexiones/config.inc.php");
 ...
 $sql="select * From convenio_referencia where cod_operacion = $cod_operacion";
$result = $db->Execute($sql);

$tipo=$result->fields["tipo"];
$desde=$result->fields["desde"];
$hasta=$result->fields["hasta"];
$columna1=$result->fields["columna1"];
$columna2=$result->fields["columna2"];
$anio_d=$result->fields["anio_d"];
$anio_h=$result->fields["anio_h"];
...
?>
    ...
    <td width="553"><div align="left"><span class="Estilo3">
      ...
      <font color="#000000">Multiplicar X</font></span><span class="Estilo3">
...
?>
  ...
  <tr align="center" bordercolor="#FFFFFF">
    ...
    <td width="130" bgcolor="#C0C0C0"><span class="Estilo3">Desde/Mayor</span></td>
    <td width="179" bgcolor="#C0C0C0"><span class="Estilo3">Hasta/Menor</span></td>
    <td width="136" bgcolor="#C0C0C0"><span class="Estilo3">Col 2 </span></td>
    <td width="116" bgcolor="#C0C0C0"><span class="Estilo3">Desde/1=</span></td>
