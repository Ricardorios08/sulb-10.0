...
<table width="850" border="0">
  <!--DWLayoutTable-->
  <tr align="center">
    <td height="37" colspan="2" bgcolor="#B8B8B8"><strong> NUEVO ANTIBIOTICO </strong></td>
  </tr>
  <tr align="center" bordercolor="#FFFFFF">
    <td height="24" bgcolor="#B8B8B8"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Nombre Antibiotico 
      
    </font>      
      <div align="left"></div></td>
    <td bgcolor="#EDEDED"><div align="left"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">
      <input type="text"  name="antibiotico" size = "80" id="practica2" onKeyPress="return verif_caracter(this,event)">
      <input name="Alta" type="submit"  value="Guardar Antibiotico" id ="Alta">
    </font></div></td>
  </tr>
</table>
