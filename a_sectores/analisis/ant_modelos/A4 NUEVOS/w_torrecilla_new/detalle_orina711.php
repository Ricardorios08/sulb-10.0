...
IF ($epiteliales == ""){$epiteliales = "No se observan";}
IF ($leucocito == ""){$leucocito = "No se observan";}
IF ($piocitos == ""){$piocitos = "No se observan";}
IF ($hematies == ""){$hematies = "No se observan";}
IF ($cilindros == ""){$cilindros = "No se observan";}
IF ($mucus == ""){$mucus = "No se observan";}
IF ($uratos == ""){$uratos = "No se observan";}
