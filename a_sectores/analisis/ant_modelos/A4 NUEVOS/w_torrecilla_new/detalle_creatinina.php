...
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(20,5,"mg/l",0);  
$pdf->ln();
$pdf->SetX(50);
$pdf->Cell(50,5,"Adulto Hombre: 7.00 a 13.00 mg/l",0); 
$pdf->ln();
$pdf->SetX(50);
$pdf->Cell(50,5,"Adulto Mujer: 6.00 a 11.00 mg/l",0); 
$pdf->ln();
$pdf->SetX(50);
$pdf->Cell(50,5,"Niños: 4.00 a 9.00 mg/l",0);  
...
$pdf->Cell(20,5,$creatinuria,0);
$pdf->SetFont($letra,'',$tamanio);
$pdf->Cell(20,5,"g/24 hs.",0);  
$pdf->ln();
$pdf->SetX(50);
$pdf->Cell(50,5,"V. de Ref: 0.90 a 1.50 g/24 hs",0);  
...
$pdf->ln();
$pdf->SetX(50);
$pdf->Cell(50,5,"V. de Ref: Hombre: 94.00 a 140.00 ml/min",0);
$pdf->ln();
$pdf->SetX(50);
$pdf->Cell(50,5,"V. de Ref: Mujer: 72.00 a 110.00 ml/min",0);
