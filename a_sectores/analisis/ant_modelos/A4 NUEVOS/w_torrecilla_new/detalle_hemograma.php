...
$pdf->Ln();
$pdf->SetX(100);
  $pdf->Cell(50,5,"FORMULA LEUCOCITARIA CADA 100 LEUCOCITOS".$contador,0);
...
$pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,5,number_format($neutro_cayado,0),0,0,'R'); 
 $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(160);
  $pdf->Cell(20,5,"%");
...
$pdf->Cell(50,5,"Neutrófilos segmentado: ",0);
  ...
  $pdf->Cell(15,5,number_format($neutro_segmentado,0),0,0,'R'); 
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(160);
  $pdf->Cell(20,5,"%");
...
$pdf->Cell(50,5,"Eosinofilos: ",0);
  ...
  $pdf->Cell(15,5,$eosinofilos,0,0,'R'); 
...
$pdf->Cell(50,5,"Basófilos: ",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,5,number_format($basofilos,0),0,0,'R');  
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(160);
  $pdf->Cell(20,5,"%");
     if ($formula == "SI"){
...
$pdf->Cell(50,5,"Linfocitos: ",0);
  $pdf->SetFont('Arial','B',$tamanio);
  $pdf->Cell(15,5,number_format($linfocitos,0),0,0,'R'); 
  $pdf->SetFont('Arial','',$tamanio);
  $pdf->SetX(160);
  $pdf->Cell(20,5,"%");
