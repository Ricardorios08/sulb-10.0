...
$renglon5 = "SAN MARTIN 2370 / CIUDAD / TELEFONO: 425-4508";
$renglon5 = "JOAQUIN V. GONZALEZ 1601 / GODOY CRUZ / TELEFONO: 439-7353";
$renglon5 = "SANATORIO A MANO / BELTRAN 95 - GODOY CRUZ / TELEFONO: 442-9950";
    $this->Cell(0,200,$renglon4,0,0,'C');
	    $this->Cell(0,100,$renglon5,0,0,'C');
}
*/
...
$a = "firma_piglionico.jpg";
$b = "firma_moor.jpg";
$c = "firma_quiroga.jpg";

 $this->Image('../../../logos/'.$a,15,129,30);
 $this->Image('../../../logos/'.$b,95,129,25);
 $this->Image('../../../logos/'.$c,165,129,30);

$this->line(10,138,200,138);
//$this->line(158,130,200,130);
    $this->Cell(0,5,'',0,0,'L');
 $this->ln();
	    $this->Cell(0,5,$renglon5.$this->PageNo(),0,0,'C');
}
...
$v = "recuadro.jpg";
$pdf->SetY(20);
  $pdf->Image('../../../logos/'.$v,80,100,50);


$letra = "ARIAL";
$pdf->SetFont($letra,'B',16);
$pdf->Cell(190,10,$renglon1,0,1,'C');


$pdf->SetFont($letra,'B',18);
$pdf->Cell(190,10,$renglon2,0,1,'C');
$pdf->SetFont('Arial','',14);
$pdf->Cell(190,5,$renglon3,0,1,'C');
...
$pdf->SetWidths(array(30,90,30,90));
