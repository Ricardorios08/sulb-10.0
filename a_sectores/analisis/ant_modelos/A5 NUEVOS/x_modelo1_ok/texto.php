<?php 
  ...
  $sql2="select * from detalle where cod_grabacion = $cod_grabacion and clase = 3 order by cod_operacion";
$result5 = $db->Execute($sql2);


   $sql2="select * from detalle join convenio_practica on (detalle.nro_practica = convenio_practica.cod_practica) where detalle.cod_grabacion = $cod_grabacion and convenio_practica.clase = 3 order by cod_operacion";
$result5 = $db->Execute($sql2);
