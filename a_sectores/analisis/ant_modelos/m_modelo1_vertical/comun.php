...
//formulas hechas para los informes
...
if ($nro_practica == 174){
 $colesterol_reservado = $valor;
}

if ($nro_practica == 1035){
$hdl = $valor;
}

if ($nro_practica == 876){

$trigliceridos_reservado = $valor;

if ($trigliceridos_reservado > 0){
$vldl = $trigliceridos_reservado / 1 /5;
}


 $ldl = $colesterol_reservado - $hdl - $vldl;


if ($hdl > 0){
$riesgo = round((1 / $hdl) * $colesterol_reservado,2);
}
...
if ($nro_practica == 543){
$insulina_reservada = $valor;
}


if ($nro_practica == 412){
$glucemia_reservada = $valor;
}
