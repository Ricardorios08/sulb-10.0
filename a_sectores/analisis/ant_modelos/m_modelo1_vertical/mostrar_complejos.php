...
$pdf->ln(); 
//$pdf->Cell(80,5,$renglon1);
$pdf->SetX(10); 
 
switch ($renglon1_4){
case "1":{$pdf->Cell(45,5,$renglon1);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor1." ".$renglon1_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon1." ".number_format($valor1,2)." ".$renglon1_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon1,0,0,L);break;}
...
switch ($renglon2_4){
case "1":{$pdf->Cell(45,5,$renglon2);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor2." ".$renglon2_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon2." ".number_format($valor2,2)." ".$renglon2_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon2,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon3);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor3." ".$renglon3_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon3." ".number_format($valor3,2)." ".$renglon3_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon3,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon4);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor4." ".$renglon4_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon4." ".number_format($valor4,2)." ".$renglon4_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon4,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon5);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor5." ".$renglon5_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon5." ".number_format($valor5,2)." ".$renglon5_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon5,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon6);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor6." ".$renglon6_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon6." ".number_format($valor6,2)." ".$renglon6_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon6,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon7);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor7." ".$renglon7_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon7." ".number_format($valor7,2)." ".$renglon7_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon7,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon8);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor8." ".$renglon8_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon8." ".number_format($valor8,2)." ".$renglon8_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon8,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon9);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor9." ".$renglon9_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon9." ".number_format($valor9,2)." ".$renglon9_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon9,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon10);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor10." ".$renglon10_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon10." ".number_format($valor10,2)." ".$renglon10_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon10,0,0,L);break;}
...
case "1":{$pdf->Cell(45,5,$renglon11);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor11." ".$renglon11_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon11." ".number_format($valor11,2)." ".$renglon11_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon11,0,0,L);break;}
...
switch ($renglon12_4){
case "1":{$pdf->Cell(45,5,$renglon12);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor12." ".$renglon12_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon12." ".number_format($valor12,2)." ".$renglon12_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon12,0,0,L);break;}
...
switch ($renglon13_4){
case "1":{$pdf->Cell(45,5,$renglon13);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor13." ".$renglon13_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon13." ".number_format($valor13,2)." ".$renglon13_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon13,0,0,L);break;}
...
switch ($renglon14_4){
case "1":{$pdf->Cell(45,5,$renglon14);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor14." ".$renglon14_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon14." ".number_format($valor14,2)." ".$renglon14_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon14,0,0,L);break;}
...
switch ($renglon15_4){
case "1":{$pdf->Cell(45,5,$renglon15);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor15." ".$renglon15_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon15." ".number_format($valor15,2)." ".$renglon15_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon15,0,0,L);break;}
...
switch ($renglon16_4){
case "1":{$pdf->Cell(45,5,$renglon16);$pdf->SetFont($letra,'B',11);$pdf->Cell(45,5,$valor16." ".$renglon16_2);$pdf->SetFont($letra,'',11);break;}
case "2":{$pdf->Cell(80,5,$renglon16." ".number_format($valor16,2)." ".$renglon16_2,0,0,L);break;}
case "3":{$pdf->Cell(80,5,$renglon16,0,0,L);break;}
