...
$pdf->Cell(75,5,"Acido ascórbico:",0);  
$pdf->SetFont($letra,'B',$tamanio);
...
$pdf->Cell(75,5,"Acido ascórbico +  análogos:",0);  
$pdf->SetFont($letra,'B',$tamanio);
...
$pdf->Cell(75,5,"Compuestos análogos:",0);  
$pdf->SetFont($letra,'B',$tamanio);
...
$pdf->Cell(75,5,"Acido ascórbico real:",0);  
$pdf->SetFont($letra,'B',$tamanio);
...
$pdf->Cell(75,5,"Fosfatasa ácida:",0);  
$pdf->SetFont($letra,'B',$tamanio);
...
$pdf->Cell(75,5,"Glicerilfosforilcolina:",0);  
$pdf->SetFont($letra,'B',$tamanio);
