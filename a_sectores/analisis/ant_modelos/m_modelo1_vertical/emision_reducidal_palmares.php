...
$pdf->Cell(130,10,$renglon1,0,1,'C');


$pdf->SetFont($letra,'B',10);
$pdf->Cell(130,10,$renglon2,0,1,'C');
$pdf->SetFont('Arial','',10);
$pdf->Cell(130,5,$renglon3,0,1,'C');
...
$pdf->setX(40);
 ...
 $pdf->line(30,90,120,90);
 $pdf->line(30,91,120,91);
...
$pdf->TextWithDirection(140,10,"N°: ".$cod_grabacion,'L');
