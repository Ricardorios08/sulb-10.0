...
/*echo $sql="select * from datos_osde where cuenta_abm = '$usuario'";
$result = $db->Execute($sql);
echo $cuenta_abm=strtoupper($result->fields["cuenta_abm"]);*/


  echo  $sql10="select * from detalle WHERE cod_grabacion = '$cod_grabacion' and facturar = 0 and nro_practica < 10000";
...
$sql10="select count(nro_practica)as hay from detalle WHERE cod_grabacion = '$cod_grabacion' and facturar = 0 and nro_practica < 10000";
$resulta11 = $db->Execute($sql10);
 
   $hay=$resulta11->fields["hay"];

if ($hay == 1){
 $pra = $pra."<Prestacion codigo='1' secuencia='2'/>";
}
