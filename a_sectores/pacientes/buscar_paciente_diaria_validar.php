...
<?PHP $usuario = $_REQUEST['usuario2'];?>

<table width="829" border="1" cellspacing="0">
  <!--DWLayoutTable-->

    <tr bgcolor="#CECECE">
    <td colspan="11" bgcolor="#CECECE"><div align="center" class="titulo"><font face="Trebuchet MS">Planilla de Trabajo desde: <?php echo $desde_m;?> Hasta: <?php echo $hasta_m;?></font></div></td>
  </tr>
 ...
 <tr >
   ...
   <td width="227" bgcolor="#666666"><div align="center" class="Estilo35">Paciente</div></td>
    ...
    <td width="88" colspan="2" bgcolor="#666666"><div align="center" class="Estilo27 Estilo35">
      <div align="center"> Solicitadas </div>
    </div>      <div align="center" class="Estilo27 Estilo35"></div>    </td>
<td width="52" bgcolor="#666666"><div align="center" class="Estilo35"><span class="Estilo26">MODIFICAR</span></div></td>
...
$nombre_completo = substr($nombre_completo,0,20);
 ...
 <tr bordercolor="#E0EDF3" bgcolor="#E0EDF3" style="cursor:hand" onMouseOver="this.style.background='#E1E1E1'; this.style.color='blue'" onMouseOut="this.style.background='#E0EDF3'; this.style.color='black'">
   ...
   <td bgcolor="#E0EDF3"><a href="buscar_paciente_validar.php?palabra=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&usuario2=<?php print("$usuario");?>"><?php echo $nombre_completo;?> <?php echo $nro_paciente;?></a></td>
    <td bgcolor="#E0EDF3"><div align="center">
      <div align="center"><?php echo $edad;?></div>
    </div></td>
    
	
	<td colspan="2" bgcolor="#E0EDF3"><?php include ("../analisis/practicas.php");?>
      <div align="center"><font size="1" face="Arial, Helvetica, sans-serif"></font></div>      <div align="center"></div>      <font size="1" face="Arial, Helvetica, sans-serif">	  
	 </font></div>     </td>

    
<td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
	<a href="../analisis/emision_mod_validar.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//951.ico" alt="Informe" border = "0"></a>
	</font></div></td>

	<td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">
	<a href="anular_osde.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//951.ico" alt="Informe" border = "0"></a>
	</font></div></td>

    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"></font><font size="1" face="Arial, Helvetica, sans-serif">
