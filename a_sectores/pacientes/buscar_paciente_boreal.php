...
<html>
<head>
<title>LISTADO DE PACIENTES SANCOR</title>
...
<table width="840" border="1" cellspacing="0">
  ...
  <tr bgcolor="#CECECE">
    <td colspan="11" valign="top"><div align="center">Planilla de Trabajo BOREAL - COBERTURA DE SALUD. Desde: <?php echo $desde_m;?> Hasta: <?php echo $hasta_m;?></div></td>
  </tr>
  
 <tr >
   <td width="28" bgcolor="#666666"><div align="center"><span class="Estilo35">ABM</span></div></td>
   <td width="57" bgcolor="#666666"><div align="center"><span class="Estilo35">BOREAL</span></div></td>
...
$detalle = "detalle";
 ...
 include("../../conexiones/config.inc.php");
    ...
    $sql2="select * from $ordenes where fecha between '$desde' and '$hasta' and nro_os = 5396 order by cod_grabacion";
