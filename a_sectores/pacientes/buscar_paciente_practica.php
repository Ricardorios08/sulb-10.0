...
<font size="2" face="Arial, Helvetica, sans-serif">
 ...
 <tr >
   <td width="24" bgcolor="#666666"><div align="center" class="Estilo35"><span class="Estilo35">ABM</span></div></td>
...
$detalle = "detalle";
 ...
 include("../../conexiones/config.inc.php");
  ...
  echo  $sql2="select * from $detalle where fecha between '$desde' and '$hasta' and nro_practica like '$palabra' order by cod_grabacion";
...
$nombre_completo = substr($nombre_completo,0,20);
 ...
 <tr bordercolor="#E0EDF3" bgcolor="#E0EDF3" style="cursor:hand" onMouseOver="this.style.background='#E1E1E1'; this.style.color='blue'" onMouseOut="this.style.background='#E0EDF3'; this.style.color='black'">
   ...
   <td bgcolor="#E0EDF3"><a href="buscar_paciente.php?palabra=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&usuario=<?php print("$usuario");?>" class="Estilo36"><?php echo $nombre_completo;?> <?php echo $nro_paciente;?></a></td>
	...
	<td bgcolor="#E0EDF3"><font size="1" face="Arial, Helvetica, sans-serif"><a href="../analisis/emision_mod.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><span class="glyphicon glyphicon-th-list"></span></div></a></a></font></td>
	<td bgcolor="#E0EDF3"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="../analisis/practicas_imp.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><img src="../../imagenes/office//011.ico" alt="Ficha" border = "0"></a></font></div></td>
    ...
    <td bgcolor="#E0EDF3"><?php include ("../analisis/practicas.php");?>
      <div align="center"><font size="1" face="Arial, Helvetica, sans-serif"></font></div></td>
    	<td bgcolor="#E0EDF3"><div align="center"><?php echo $total_orden;$total_orden = "";?></div></td>
		   	<td bgcolor="#E0EDF3"><div align="center"><?php echo $total_acumulado;?></div></td>
	<td bgcolor="#E0EDF3"><div align="center"><?php echo $estado;?></div></td>
	<td bgcolor="#E0EDF3"><font size="3" face="Arial, Helvetica, sans-serif"><a href="../analisis/emision_mod.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><span class="glyphicon glyphicon-th-list"></span></div></a></font></td>
	<td bgcolor="#E0EDF3"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif"><a href="../analisis/practicas_imp.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><span class="glyphicon glyphicon-share-alt"></span></a></font></div></td>
