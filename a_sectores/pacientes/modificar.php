...
<table width="829" border="0" cellspacing="0">
  ...
  <tr bgcolor="#CECECE">
    ...
    <tr  >
      ...
      <td rowspan="14" align="center" valign="top" bgcolor="#F0F0F0"><span class="Estilo45">
        <?php 
...
?>
    ...
    <tr  >
      <td height="24" bgcolor="#EDEDED"><span class="Estilo46"><font color="#000000">COD SEG </font></span></td>
      <td bgcolor="#F0F0F0"><span class="Estilo41"><font color="#000000">
        <input name="cod_seg" type="text" id="cod_seg" onKeyPress="return verif_caracter(this,event)" value="<?php echo $cod_seg;?>" size="8" maxlength="8">
      </font></span></td>
    </tr>
    <tr  >
