...
$result10 = $db->Execute($sql10);
 ...
 $sucursal=$result10->fields["sucursal"];
   $sucursal_swiss=$result10->fields["sucursal_swiss"];
   $matricula_swiss=$result10->fields["matricula_swiss"];
   $cuit_swiss=$result10->fields["cuit_swiss"];
