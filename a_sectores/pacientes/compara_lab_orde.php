...
$sql="select * from datos_laboratorio order by nro_laboratorio asc";
...
<table width="1495" border="0">
  <tr bgcolor="#FFFFFF">
    <td colspan="9"><div align="center">LISTADO DE CUENTAS ABM CONTRA BIOQUIMICOS</div></td>
  </tr>
  <tr bgcolor="#CCCCCC">
