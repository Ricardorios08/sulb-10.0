...
$cuenta_abm=strtoupper($result5->fields["cuenta_abm"]);
 ...
 $sucursal=$result5->fields["sucursal"];
 $sucursal_swiss=$result5->fields["sucursal_swiss"];
$matricula_swiss=$result5->fields["matricula_swiss"];
  $cuit_swiss=$result5->fields["cuit_swiss"];
...
case "5543":{	include ("staff_ws.php");break;}
}
