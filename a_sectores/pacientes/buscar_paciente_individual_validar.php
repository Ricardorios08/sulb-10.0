 ...
 ?>
  <table width="829" border="1" cellspacing="0">
    ...
    <tr >
      ...
      <td width="39" bgcolor="#666666"><div align="center"><span class="Estilo26">MODIFICAR ORDEN</span></div></td>
	...
	<td bgcolor="#EDEDED"><div align="center"><a href="reimprimir_validar.php?nro_paciente=<?php print("$nro_paciente");?>&&usuario=<?php print("$usuario");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><?php echo $autorizacion_ws;?></a></div></td>
	<?php }else{?>
