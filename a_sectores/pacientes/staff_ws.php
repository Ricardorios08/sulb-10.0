...
// $sql10="select * from detalle WHERE cod_grabacion = '$cod_grabacion' and facturar = 0 and nro_practica < 10000";
 // $sql10="select * from detalle WHERE cod_grabacion = '$cod_grabacion' and nro_practica < 10000";

      $sql10="select * from detalle WHERE (cod_grabacion = '$cod_grabacion' and facturar = 0 and nro_practica < 10000) or (cod_grabacion = '$cod_grabacion' and facturar = 1 and nro_practica < 10000)";
...
file_put_contents("respuesta_staff.xml", $result);
...
<table width="315" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#B8B8B8"><div align="center" class="Estilo2">VALIDACION STAFF MEDICO SULB </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
      <td bgcolor="#B8B8B8"><div align="center"><span class="Estilo3 Estilo1">Respuesta Staff</span></div></td>
    </tr>
  <tr>
