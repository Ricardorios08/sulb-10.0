...
<table width="840" border="1" cellspacing="0">
  ...
  <tr bgcolor="#CECECE">
    <td colspan="11" valign="top"><div align="center">Planilla de Trabajo SWISS MEDICAL. Desde: <?php echo $desde_m;?> Hasta: <?php echo $hasta_m;?></div></td>
  </tr>
  
 <tr >
   <td width="28" bgcolor="#666666"><div align="center"><span class="Estilo35">ABM</span></div></td>
   <td width="57" bgcolor="#666666"><div align="center"><span class="Estilo35">SWISS</span></div></td>
   ...
   <td width="262" bgcolor="#666666"><div align="center" class="Estilo35">Paciente</div></td>
    <td width="56" bgcolor="#666666"><div align="center" class="Estilo35">Matricula</div></td>
    <td width="113" bgcolor="#666666"><div align="center" class="Estilo27 Estilo35">
      <div align="center"> Solicitadas </div>
    </div>      <div align="center" class="Estilo27 Estilo35"></div></td>
    <td width="42" bgcolor="#666666"><div align="center" class="Estilo35"><span class="Estilo26">COMP.</span></div></td>
    <td width="57" bgcolor="#666666"><div align="center" class="Estilo28 Estilo35">INF.</div></td>
...
$detalle = "detalle";
 ...
 include("../../conexiones/config.inc.php");
    ...
    $sql2="select * from $ordenes where fecha between '$desde' and '$hasta' and nro_os = 4723 order by cod_grabacion";
  ...
  <td bgcolor="#E0EDF3"><div align="center"><?php echo $autorizacion;?></div></td>
   ...
   <td bgcolor="#E0EDF3"><a href="buscar_paciente.php?palabra=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><?php echo $nombre_completo;?> <?php echo $nro_paciente;?></a></td>
    <td bgcolor="#E0EDF3"><div align="center">
      <div align="center"><?php echo $cuenta_abm;?></div>
    </div></td>
    <td bgcolor="#E0EDF3"><?php include ("practicas.php");?>
      <div align="center"><font size="1" face="Arial, Helvetica, sans-serif"></font></div></td>
    
	<?php if ($tipo_operador == "val"){?>
	<td bgcolor="#E0EDF3"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif">
	<a href="../analisis/emision_mod_validar.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><span class="glyphicon glyphicon-th-list"></span></div></a></font></div></td>
<?php }else{?>
<td bgcolor="#E0EDF3"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif">
	<a href="../analisis/emision_mod.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>"><span class="glyphicon glyphicon-th-list"></span></div></a></font></div></td>
<?php }?>


	<td bgcolor="#E0EDF3"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><a href="borra_orden.php?cod_grabacion=<?php print("$cod_grabacion");?>" onclick="return confirm('¿Está seguro de Borrar la orden y sus RESULTADOS?');"></a></font><font size="1" face="Arial, Helvetica, sans-serif"><a href="../analisis/modelos/elegir_modelos.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><img src="../../imagenes/office//005.ico" alt="Informe" border = "0"></a></font></div></td>
...
?>
     <td bgcolor="#E0EDF3"><div align="center"><?php echo $autorizacion;?></div></td>
   <td bgcolor="#E0EDF3"><div align="center"><?php echo $autorizacion_ws;?></a></div></td>
...
<?php }?>
	...
	<a href="autorizar1.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>&&desde=<?php print("$desde");?>&&hasta=<?php print("$hasta");?>"></a>
	</font>
	
	<font size="1" face="Arial, Helvetica, sans-serif">
	<a href="autorizar_osde.php?nro_paciente=<?php print("$nro_paciente");?>&&cod_grabacion=<?php print("$cod_grabacion");?>&&fecha_grabacion=<?php print("$fecha_grabacion");?>&&nro_afiliado=<?php print("$nro_afiliado");?>&&modulo=<?php print("$modulo");?>&&usuario=<?php print("$usuario");?>"><div align="center"><font size="4"><span class="glyphicon glyphicon-text-background"></span></div></a>
	</font></div>
	</td>
