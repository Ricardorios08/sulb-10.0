...
$xml = "<ConsultaElegibilidad>
  <Beneficiario>
    <nroBeneficiario>String</nroBeneficiario>
    <tipoDocumento>String</tipoDocumento>
    <nroDocumento>String</nroDocumento>
    <apellidoNombre>String</apellidoNombre>
    <plan>String</plan>
    <versionCredencial>String</versionCredencial>
    <programa>String</programa>
    <descuentoFarmacia>String</descuentoFarmacia>
    <tipoBeneficiario>String</tipoBeneficiario>
    <fechaNacimiento>String</fechaNacimiento>
    <edad>String</edad>
    <condicionIva>String</condicionIva>
    <sexo>String</sexo>
    <estado>String</estado>
    <codigoEstado>String</codigoEstado>
    <materialRadioactivo>String</materialRadioactivo>
    <materialContraste>String</materialContraste>
  </Beneficiario>
  <Prestador>
    ...
    <tipoPrestador>String</tipoPrestador>
  </Prestador>
  <Transaccion>
    <idMensaje>String</idMensaje>
    <tipoTransaccion>String</tipoTransaccion>
    <codigoAutorizacion>String</codigoAutorizacion>
    <estado>String</estado>
    <codigoEstado>String</codigoEstado>
...
/*$xml ="<consultaElegibilidad>      
            <beneficiario>         
               ...
               <nroBeneficiario>8000067180171000054</nroBeneficiario>         
               <plan></plan>         
               <programa></programa>         
            ...
            <prestador>         
               <tipoIdentificacion>CUIT</tipoIdentificacion>         
               <identificacion>30546107074</identificacion>         
            ...
            <transaccion>         
               ...
               <estado></estado>         
               <codigoEstado></codigoEstado>         
               <codigoTerminal>CXIA00000026</codigoTerminal>         
               <fechaHora></fechaHora>         
               <codigoAutorizacionAnulado></codigoAutorizacionAnulado>         
               <financiador>SWISS</financiador>         
               <tipoIngreso>M</tipoIngreso>
            </transaccion>
         </consultaElegibilidad>";
*/
...
$oSoapClient = new soapclient('http://190.216.73.205:8080/web-service/integration?wsdl');
$aParametros = array("consultarElegibilidad" => "<?xml version='1.0' standalone='yes' ?><ConsultaElegibilidad>
  <Beneficiario>
    <nroBeneficiario>String</nroBeneficiario>
    <tipoDocumento>String</tipoDocumento>
    <nroDocumento>String</nroDocumento>
...
exit;
 $result->Egresoxml;
  ...
  file_put_contents("respuesta_conexia.xml", $result->Egresoxml);
...
$xml = simplexml_load_file("respuesta_conexia.xml");
