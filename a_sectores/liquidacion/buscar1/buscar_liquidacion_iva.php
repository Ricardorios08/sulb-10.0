...
<table width="800" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="499" height="20" bgcolor="#FFFFFF" scope="col"><div align="center" class="Estilo23">
      <div align="left" class="Estilo26">Cuenta: <?php echo $nombre_laboratorio;?>      </div>
    </div></td>
    <td width="150" bgcolor="#FFFFFF" scope="col"><div align="center"><span class="Estilo13">Periodo: <?php echo $periodo_liq;?> - 20<?php echo $anio_liquidacion_liq;?> </span></div></td>
  </tr>
  <tr>
...
$imp=$result123->fields["importe"];

$exen = $imp - $iva - $neto_gravado;
if ($sit_iva == 1){
...
<tr class="Estilo7">
    ...
    <td class="Estilo7"><div align="center"><?php echo $nro_liquidacion;?>-<?php echo $periodo_liquidacion;?>/<?php echo $anio_liquidacion;?></div></td>
    <td class="Estilo7"><div align="center"><?php echo number_format($porcentaje,2);?></div></td>
    ...
    <td><div align="right" class="Estilo2" ><?php echo number_format($exen,2);?>  </div></td>
    <td><div align="right"><span class="Estilo2"><?php echo number_format($neto_porc,2);?></span></div></td>
    <td><div align="right" class="Estilo2"> <?php echo $iva_porc;?> </div></td>
...
<tr class="Estilo7">
    ...
    <td><div align="center"><span class="Estilo7"><?php echo $nro_factura;?> <?php echo $marca;?></span></div></td>
    <td><span class="Estilo7"><?php echo $fecha_original_fact;?></span></td>
    <td><div align="right" class="Estilo2" > /<?php  number_format($exento_porc,2);?>  </div></td>
    <td><div align="right"><span class="Estilo2"><?php  echo number_format($importe_original,2);?></span></div></td>
    <td><div align="right" class="Estilo2"> -<?php echo $iva_porc;?> </div></td>
     <td><div align="right" class="Estilo2"><?php echo number_format($bruto,2);?> </div></td>
  </tr>
...
?><tr class="Estilo7">
  ...
  <tr class="Estilo7">
  <td colspan="6" class="Estilo7"><div align="right"><span class="Estilo13 Estilo11"></span></div></td>
  <td><div align="right" class="Estilo2" > <?php echo number_format($total_exe,2);?> </div></td>
  <td><div align="right"><span class="Estilo2"><?php echo number_format($total_ng,2);?></span></div></td>
  <td><div align="right" class="Estilo2"> <?php echo number_format($total_iva,2);?> </div></td>
  <td><div align="right" class="Estilo2"><?php echo number_format($total_total,2);?> </div></td>
</tr>
  <tr>
     <td colspan="6" valign="top"><div align="right"><span class="Estilo13 Estilo11"></span></div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2"><?php echo number_format($total_total1,2);?></div></td>
...
<tr>
     ...
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2" >       <?php echo number_format($ex,2);?> </div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right"><span class="Estilo2"><?php echo number_format($ng,2);?></span></div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2"> <?php echo number_format($iv,2);?> </div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2"><?php echo number_format($to,2);?> </div></td>
     </tr>
<?php }else{?>
<tr>
     <td colspan="6" valign="top"><div align="right"><span class="Estilo13 Estilo11"><span class="Estilo25">SUBTOTAL</span></span></div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2" >       <?php  number_format($ex,2);?> </div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right"><span class="Estilo2"><?php  number_format($ng,2);?></span></div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2"> <?php echo number_format($iv,2);?> </div></td>
     <td valign="top" bgcolor="#FFFFFF" class="Estilo7"><div align="right" class="Estilo2"><?php echo number_format($to,2);?> </div></td>
     </tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="356"><div align="right" class="Estilo12">-<?php echo number_format($debitos,2);?></div></td>
  </tr>
  <tr>
    <td><div align="right" class="Estilo12"><strong>+ CREDITOS <strong>REALIZADOS POR OBRA SOCIAL</strong></strong></div></td>
    <td><div align="right"><span class="Estilo11 Estilo26"><span class="Estilo2 Estilo11"><?php echo number_format($creditos,2);?></span></span></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><hr noshade></td>
  ...
  <tr>
    ...
    <td><div align="right"><span class="Estilo3"><?php echo number_format($tot_mes,2);?></span></div></td>
  </tr>
  <tr>
 ...
 switch ($sit_iva){
   ...
   <tr>
     ...
     <td width="97"><div align="right" class="Estilo12"><?php echo number_format($total_ng,2);?></div></td>
     <td width="128"><div align="right"><span class="Estilo12"><?php echo number_format($total_exento_a,2);?></span></div></td>

     <td width="143"><div align="right" class="Estilo12"><?php echo number_format($total_iva,2);?></div></td>
     <td width="88"><div align="right" class="Estilo12"><span class="Estilo11 Estilo26"><span class="Estilo3"><?php echo number_format($tot_mes,2);?></span></span></div></td>
   </tr>
   <?php 
	 break;
	 }
...
?> <tr>
     ...
     <td colspan="4"><div align="center"></div>       <div align="right" class="Estilo12"><?php echo number_format($tot,2);?></div></td>
     </tr>
<?php 
}
