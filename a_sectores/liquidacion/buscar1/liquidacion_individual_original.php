...
?>
<tr>
    <td colspan="10"><div align="right"><span class="Estilo19">SALDO DE FACTURAS ADEUDADAS ANTERIOR A LA LIQUIDACION: <?  number_format($importe,2);?></span>
...
<tr bgcolor="#FFFFFF" class="Estilo8">
  <td colspan="10"><div align="left"><span class="Estilo14">FACTURAS PAGADAS A LA FECHA</span></div></td>
</tr>
<tr bgcolor="#FFFFFF" class="Estilo12">
  <td width="78"><div align="center" class="Estilo2">Fec. Cob </div></td>
  <td width="110"><div align="center" class="Estilo2">O.Social</div></td>
  <td width="42"><div align="center"><span class="Estilo2">Periodo</span></div></td>
  <td width="17"><div align="center"><span class="Estilo7">%</span></div></td>
  <td width="52"><div align="center" class="Estilo2">Saldo</div></td>
...
?>
<tr class="Estilo7">
    <td class="Estilo7"><span class="Estilo2"><?echo $renglon;?>) <?echo $fecha_pago_fact;?></span></td>
...
?>
<tr><td colspan="6" scope="col"><?echo $renglon;?>)</td>
  <td colspan="4" scope="col"><hr noshade></td>
  </tr>
<tr class="Estilo7">
  <td colspan="9" class="Estilo7" scope="col"><div align="right" class="Estilo2"></div>    <div align="right"><span class="Estilo2">Total Facturas Pagadas a liquidar: </span></div>    <div align="right"></div>    <div align="right"></div>    <div align="right" class="Estilo6">
        <div align="right"></div>
    </div></td>
...
<tr class="Estilo7">
  <td colspan="10" class="Estilo19" scope="col"><div align="right"> SALDO ACTUALIZADO DE FACTURAS ACREEDITADAS PENDIENTES DE PAGO:  <? number_format($importe,2);?></div></td>
  <tr class="Estilo7">
...
$banderin = 0;
  ...
  <tr bgcolor="#FFFFFF" class="Estilo8">
    <td width="76" scope="col"><div align="center" class="Estilo3 Estilo4 Estilo9"><span class="Estilo5  Estilo2">Fec. Mov. </span></div></td>
    <td width="90" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">O. Social </span></div></td>
    <td width="49" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Comp.</span></div></td>
    <td width="50" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Fec. Orig.</span></div></td>
    <td width="197" scope="col"><div align="center" class="Estilo5 Estilo9">Motivo</div></td>
    <td width="47" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo7"><span class="Estilo5">Debitos</span></span></div></td>
    <td width="42" scope="col"><div align="center" class="Estilo5 Estilo9">Cr&eacute;dito</div></td>
    <td width="56" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Neto</span></div></td>
  </tr>
  <tr class="Estilo7">
...
?>   <tr class="Estilo7">
    <td width="76" scope="col"><span class="Estilo2"><?echo $renglon;?>) <?ECHO $fecha;?></span></td>
    <td width="89" scope="col"><span class="Estilo2"><?ECHO $sigla;?></span></td>
    <td width="49" scope="col"><div align="center"><span class="Estilo2"><?ECHO $nro_factura;?></span></div></td>
    <td width="41" scope="col"><div align="center"><span class="Estilo2"><?ECHO $fecha;?></span></div></td>
    <td width="209" scope="col"><div align="left"><span class="Estilo2"><?ECHO $motivo;?></span></div></td><td width="43" scope="col"><div align="right"><span class="Estilo2"> - </span></div></td>
    <td width="42" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($importe,2);?></span></div></td>
<td width="58" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($saldo_debitos,2);?></span></div></td>
  </tr>
<?
		break;}
...
?>  
  ...
  <tr class="Estilo7">
    ...
    <td width="49" scope="col"><div align="center"><span class="Estilo2"><?ECHO $nro_factura;?></span></div></td>
    <td width="41" scope="col"><div align="center"><span class="Estilo2"><?ECHO $fecha;?></span></div></td>
    <td width="209" scope="col"><div align="left"><span class="Estilo2"><?ECHO $motivo;?></span></div></td>
    <td scope="col"><div align="right"><?ECHO number_format($importe,2);?></div></td>
    <td scope="col"><div align="right">-</div></td>
    <td width="58" scope="col"><div align="right"><?ECHO number_format($saldo_debitos,2);?></div></td>
  </tr>
<?	
...
?> <tr class="Estilo7">
    <td width="60" scope="col"><span class="Estilo2"><?ECHO $fecha;?></span></td>
...
<tr class="Estilo7">
    ...
    <td width="84" class="Estilo2" scope="col"><div align="center" class="Estilo10"><span class="Estilo7"><?ECHO number_format($dif_cose,2);?></span></div></td>
    <td width="105" class="Estilo2" scope="col"><div align="left"><span class="Estilo7"> </span></div></td>
    <td width="94" class="Estilo2" scope="col"></div>
...
if ($importe > 0){
 ...
 <tr class="Estilo7">
    ...
    <div align="center" class="Estilo10"></div></td>
    <td width="84" class="Estilo2" scope="col"><div align="center" class="Estilo10"><span class="Estilo10"><?ECHO number_format($dgr_base,2);?></span></div></td>
...
if ($acree != 1){
  ...
  <td colspan="10" bgcolor="#FFFFFF" class="Estilo6 Estilo4 Estilo9"  scope="col">&nbsp;</td>
    ...
    <tr class="Estilo6 Estilo4 Estilo9">
      <td colspan="9" bgcolor="#FFFFFF" class="Estilo6 Estilo4 Estilo9"  scope="col"><div align="right">SALDO PENDIENTE DE PAGO : $ </div></td>
