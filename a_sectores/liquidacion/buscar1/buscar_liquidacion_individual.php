...
<table width="641" border="0">
 ...
 <tr bgcolor="#FFFFFF" class="Estilo7">
    <td colspan="11"><div align="right" class="Estilo24">Liquidacion N&ordm;: <?php echo $nro_liquidacion;?> - Periodo: <?php echo $periodo;?> - 20<?php echo $anio_liquidacion;?> </div></td>
 </tr>
  <tr bgcolor="#FFFFFF">
...
<tr class="Estilo7">
    ...
    <td><div align="center"><span class="Estilo7"><?php echo $nro_factura;?></span></div></td>
    ...
    <td><div align="right" class="Estilo2"> -<?php echo number_format($ex_capita,2);?> </div></td>
...
<tr class="Estilo7">
  <td colspan="10" class="Estilo19" scope="col"><div align="right">SALDO ACTUALIZADO DE FACTURAS ADEUDADAS POR OBRA SOCIAL <?php  echo number_format($importe,2);?></div></td>
  <tr class="Estilo7">
...
<tr class="Estilo7"><td height="20" colspan="6" valign="top" class="Estilo2" scope="col"><div align="right" class="Estilo2">Sub -Total Neto Retenciones y Aportes</div></td>
  <td valign="top" class="Estilo2" scope="col"><div align="right"><span class="Estilo7">-<?php ECHO number_format($total_importe,2);?>
  </span></div></td>
...
?>
      ...
      <tr bgcolor="#FFFFFF" class="Estilo8">
        ...
        <td width="67" class="Estilo5" scope="col"><div align="center" class="Estilo9"><?php echo  $fecha_movimiento;?></div></td>
	...
	<?php $saldo_total = $saldo_total + $saldo_deuda;
