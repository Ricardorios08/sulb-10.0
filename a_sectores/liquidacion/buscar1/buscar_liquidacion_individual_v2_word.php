...
$leyenda = "Sres Profesionales a partir de Febrero de 2011 la retención de Ingresos Brutos es del  3.00 %";
...
$nombre_lab=ucwords($result5->fields["nombre_laboratorio"]);
...
echo "dsf".$b = $nombre_lab."-".$nro_liq."-".$periodo."-".$anio;
...
<table width="641" border="0">
 ...
 <tr bgcolor="#FFFFFF" class="Estilo7">
    <td colspan="11"><div align="right" class="Estilo24">Liquidacion N&ordm;: <?echo $nro_liquidacion;?> / <?echo $periodo_liq;?> - 20<?echo $anio_liquidacion;?> </div></td>
 </tr>
  <tr bgcolor="#FFFFFF">
...
<tr>
  <td colspan="10"><div align="right"><span class="Estilo19">SALDO INICIAL DE FACTURAS ADEUDADAS POR OBRA SOCIAL AL 
      <?  echo $fecha;?>:
      $<?  echo number_format($importe,2);?></span>
      </div>      
    <div align="right" class="Estilo21"><div align="center" class="Estilo6"></div>
    </div></td>
 </tr>
 <tr>
    <td colspan="10"> <div align="center"><?  echo $leyenda;?>
    </div></td>
 </tr>
...
<tr class="Estilo7">
    ...
    <td><div align="right"><span class="Estilo2"><?echo $a_cuenta;?></span></div></td>
...
<tr class="Estilo7">
  ...
  <td class="Estilo7" scope="col"><div align="right"><span class="Estilo13"><?ECHO number_format($tot_importe,2);?></span></div></td>
  <td class="Estilo7" scope="col"><div align="right"><?ECHO number_format($total_a_cuenta,2);?></div></td>
  <td class="Estilo7" scope="col"><div align="right"><span class="Estilo13"><?ECHO number_format($tot_ex,2);?></span></div></td>
  <td><div align="right"><span class="Estilo13"><?ECHO number_format($bruto,2);?></span></div></td>
...
<tr class="Estilo7">
  ...
  <td><div align="right"><span class="Estilo2"><?echo number_format($total_excedente,2);?></span></div></td>
<tr class="Estilo7">
  <td colspan="10" class="Estilo7" scope="col"><div align="right"><span class="Estilo2 Estilo10">IVA</span></div></td>
  <td><div align="right"><span class="Estilo2"><?echo number_format($total_iva,2);?></span></div></td>
<!-- <tr class="Estilo7">
  <td colspan="10" class="Estilo7" scope="col"><div align="right"> A CUENTA </div></td>
  <td><div align="right"><span class="Estilo2"><?echo number_format($total_a_cuenta,2);?></span></div></td> -->
<tr class="Estilo7">
  <td colspan="11" class="Estilo19" scope="col"><hr noshade></td>
<tr class="Estilo7">
  <td colspan="11" class="Estilo19" scope="col"><div align="right">SALDO ACTUALIZADO DE FACTURAS ADEUDADAS POR OBRA SOCIAL <? echo number_format($importe,2);?></div></td>
  <tr class="Estilo7">
...
include ("sin_acreeditaciongo.php");
...
?>
  ...
  <tr bgcolor="#000099" class="Estilo8">
    ...
    <td bgcolor="#FFFFFF"  scope="col"><div align="right"><span class="Estilo29"><?ECHO number_format($importe,2);?></span></div></td>
  </tr>
  <tr bgcolor="#000099" class="Estilo8">
    <td width="257" bgcolor="#FFFFFF" scope="col"><div align="center" class="Estilo28 Estilo9">      <div align="center" class="Estilo12">    <div align="left"></div>
      </div>
...
<tr class="Estilo7">
    ...
    <div align="center" class="Estilo10"></div></td>
    <td width="83" class="Estilo2" scope="col"><div align="center" class="Estilo10"><span class="Estilo7"><?ECHO number_format($base_cos,2);?></span></div></td>
    <td width="73" class="Estilo2" scope="col"><div align="left"><span class="Estilo7"><?ECHO number_format($porcentaje,2)." %";?>  </span></div></td>
    <td width="66" class="Estilo2" scope="col"><div align="right">-<?
...
?>  
  ...
  <tr class="Estilo7">
    ...
    <div align="center" class="Estilo10"></div></td>
    <td width="83" class="Estilo2" scope="col"><div align="center" class="Estilo10"><?ECHO number_format($bruto,2);?></div></td>
    <td width="72" class="Estilo2" scope="col"><div align="left"><span class="Estilo10"><?ECHO number_format($acumulado_mensual,2);?></span></div></td>
    <td width="68" valign="top" class="Estilo2" scope="col">      <div align="right">
      -<?
	ECHO number_format($importe,2);?>    
    </div>
    <td width="55" valign="top" class="Estilo2" scope="col">    
    <td width="88" class="Estilo2" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($saldo_retenciones_adm,2);?></span> </div></table>
...
if ($importe > 0){
 ...
 <tr class="Estilo7">
    ...
    <div align="center" class="Estilo10"></div></td>
    <td width="83" class="Estilo2" scope="col"><div align="center" class="Estilo10"><span class="Estilo10"><?ECHO number_format($dgr_base,2);?></span></div></td>
    <td width="70" class="Estilo2" scope="col"><div align="left"><span class="Estilo7"><?ECHO number_format($porcentaje,2)." %";?>  </span></div></td>
    <td width="69" valign="top" class="Estilo2" scope="col"><div align="right">-<?
	ECHO number_format($importe,2);?>    
    </div>
    <td width="57" valign="top" class="Estilo2" scope="col">    
    <td width="87" class="Estilo2" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($saldo_retenciones_adm,2);?></span> </div>
<?
...
?>
  ...
  <tr>
    ...
    <td width="73" scope="col"><div align="right"><span class="Estilo49 Estilo7"><strong><? echo number_format($saldo_novedades,2);?></strong></span></div></td>
  </tr>
