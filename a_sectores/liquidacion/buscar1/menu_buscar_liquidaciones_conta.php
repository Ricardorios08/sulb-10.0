...
<BODY background="../../../IMAGENES/IZQUIERDA.PNG" onload = "on_load ()"">
	  ...
	  <form action="buscar_liquidacion_pdf.php" method="post"  target ="central">
	    <table width="152" border="0">
      <tr bgcolor="#000099">
        <td colspan="2"><div align="center"><font color="#FFFFFF"><strong>IVA</strong></font> </div></td>
      </tr>
    ...
    <tr>
            <td colspan="2"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif">
                <input name="que_ver" type="radio" value="5" checked>
        UNICO</font></div></td>
          </tr>

	   <tr>
        <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif">
          <input name="que_ver" type="radio" value="11" >
         MASIVO
</font></td>
      </tr>
 ...
 <tr>
      ...
      <tr>
        ...
        <div align="center"><a href="../../../validar/contaduria.php" target ="central"><font color="#0000FF">Menu</font></a> </div></td>
      </tr>
