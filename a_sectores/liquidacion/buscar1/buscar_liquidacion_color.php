...
include ("buscar_liquidacion_individual.php");
	...
	{
include ("buscar_liquidacion_deuda.php");
	}
exit;
}
...
<?
 ...
 $sql2 = "SELECT * FROM `liquidacion` WHERE  `nro_laboratorio` = '$nro_laboratorio' AND `anio` like '$anio' and periodo like '$periodo' and nro_liquidacion = $nro_liquidacion order by operacion";
...
<table width="641" border="0">
  <tr bgcolor="#C9FADF">
    <td colspan="9" scope="col"><div align="center" class="Estilo12">AJUSTES SOBRE FACTURAS PAGADAS (DEBITOS O CREDITOS)</div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td colspan="9" scope="col"><hr noshade></td>
  </tr>
  <tr bgcolor="#000099" class="Estilo8">
    ...
    <td width="56" scope="col"><div align="center" class="Estilo5"><span class="Estilo5">Fec. Orig.</span></div></td>
...
?>	
  ...
  <tr>
    <td colspan="7" class="Estilo2" scope="col"><span class="Estilo7">SUB - TOTAL NETO DE RETENCIONES </span></td>
    <td class="Estilo2" scope="col"><div align="center"></div></td>
...
<tr class="Estilo7">
  <td colspan="9" scope="col"><strong>IMPORTE ACREDITADO EN BANCO</strong><span class="Estilo15"><strong>:</strong></span><strong><?ECHO $banco;?> - SUCURSAL: </strong><strong><?ECHO $sucursal;?> - TIPO:</strong><strong> <?ECHO $cuenta;?> - N&ordm;: <?ECHO $nro_cuenta;?> </strong></td>
  <td colspan="4" scope="col"><div align="right" class="Estilo15"><strong><span class="Estilo7">$ <?ECHO number_format($saldo_novedades,2);?></span></strong></div></td>
</tr></table>
<?
		}
...
$sql_deuda = "SELECT * FROM liquidacion WHERE `nro_laboratorio` = '$nro_laboratorio' and nro_liquidacion = $nro_liquidacion and periodo = $periodo and anio = $anio1 and operacion = 2000";
