...
$sql20 = "SELECT * FROM `liquidacion` WHERE  operacion = 200 and periodo like '$periodo' and `anio` like '$anio_liquidacion' and nro_liquidacion = 2 group by nro_laboratorio";
...
<?
 ...
 $sql2 = "SELECT * FROM `liquidacion` WHERE  `nro_laboratorio` = '$nro_laboratorio' AND `anio` like '$anio_liquidacion' and periodo like '$periodo' and nro_liquidacion = $nro_liquidacion order by operacion, motivo";
...
?>
<tr>
    <td colspan="8"><div align="right"><span class="Estilo19">SALDO DE FACTURAS ADEUDADAS ANTERIOR A LA LIQUIDACION: <?  number_format($importe,2);?></span>
...
<tr class="Estilo7">
  <td colspan="8" class="Estilo19" scope="col"><div align="right">SALDO ACTUALIZADO DE FACTURAS ACREEDITADAS PENDIENTES DE PAGO:  <? number_format($importe,2);?></div></td>
  <tr class="Estilo7">
...
<table width="641" border="0">
  ...
  <tr bgcolor="#000099" class="Estilo8">
    <td width="257" bgcolor="#FFFFFF" scope="col"><span class="Estilo12&gt; &lt;div align= Estilo9 Estilo11"><strong>RETENCIONES</strong></span></td>
    <td width="81" bgcolor="#FFFFFF" scope="col"><!--DWLayoutEmptyCell-->&nbsp;</td>
...
?>  <table width="641" border="0">
<tr class="Estilo7">
    <td width="250" height="20" class="Estilo2" scope="col"><div align="right"><span class="Estilo7">Contribución Servicios Administrativos:</span></div>
...
$sql12="select sum(saldo_deuda) as saldo_total from liquidacion where `nro_laboratorio` = '$nro_laboratorio' AND `anio` like '$anio_liquidacion' and periodo like '$periodo' and nro_liquidacion = $nro_liquidacion and operacion = 2000 order by operacion";
$result12 = $db_liq->Execute($sql12);
