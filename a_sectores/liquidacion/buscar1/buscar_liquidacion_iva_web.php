...
<table width="800" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="499" height="20" bgcolor="#FFFFFF" scope="col"><div align="center" class="Estilo23">
      <div align="left" class="Estilo26">Cuenta: <?echo $nombre_laboratorio;?>   (<?echo $nro_laboratorio;?>)   </div>
    </div></td>
...
<?$string1 =$periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."01".$sep.$nombre_laboratorio.$sep.$periodo_liq."-20".$anio_liquidacion_liq.$sep.$sit_iva.$enter;
...
$string2 =$periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."02".$sep.$sigla." (".$nro_os.")".$sep.$nro_liquidacion."-".$periodo_liquidacion."/".$anio_liquidacion.$sep.round($porcentaje,2).$sep."COMPLETA".$sep.$nro_factura.$marca.$sep.$fecha_original_fact.$sep.$exento_porc.$sep.$neto_porc.$sep.$iva_porc.$sep.$bruto.$enter;
...
<?
$string2 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."02".$sep.$sigla." (".$nro_os.")".$sep.$nro_liquidacion."-".$periodo_liquidacion."/".$anio_liquidacion.$sep.ROUND($porcentaje,2).$sep."COMPLETA".$sep.$nro_factura.$marca.$sep.$fecha_original_fact.$sep.$exento_porc.$sep.$importe_original.$sep.$iva_porc.$sep.$bruto.$enter;
fputs($DescriptorFichero,$string2);	
...
$string3 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."03".$sep." FACTURAS LIQUIDADAS CON IVA".$sep.$total_exe.$sep.$total_ng.$sep.$total_iva.$sep.$total_total.$enter;
fputs($DescriptorFichero,$string3);
$string4 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."04".$sep." FACTURAS LIQUIDADAS SIN IVA ".$sep.$total_total1.$sep.$sep.$sep.$total_total1.$enter;
fputs($DescriptorFichero,$string4);
...
$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."05".$sep."SUB TOTAL ".$sep.$ex.$sep.$ng.$sep.$iv.$sep.$to.$enter;
fputs($DescriptorFichero,$string5);
...
$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."05".$sep."SUB TOTAL ".$sep.$sep.$sep.$sep.$to.$enter;
fputs($DescriptorFichero,$string5);
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <?$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."06".$sep."- DEBITOS REALIZADOS POR OBRA SOCIAL ".$sep.$sep.$sep.$sep.$debitos.$enter;
fputs($DescriptorFichero,$string5);?>
  ...
  <tr>
    ...
    <td><div align="right"><span class="Estilo11 Estilo26"><span class="Estilo2 Estilo11"><?echo number_format($creditos,2);?></span></span></div></td>
	  ...
	  <?$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."06".$sep."+ CREDITOS REALIZADOS POR OBRA SOCIAL ".$sep.$sep.$sep.$sep.$creditos.$enter;
fputs($DescriptorFichero,$string5);?>
  ...
  <tr>
    ...
    <td><div align="right"><span class="Estilo3"><?echo number_format($tot_mes,2);?></span></div></td>
	  ...
	  <?$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."07".$sep."TOTAL DEL MES ".$sep.$sep.$sep.$sep.$tot_mes.$enter;
fputs($DescriptorFichero,$string5);?>
...
$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."08".$sep."Servicios afiliados Voluntarios".$sep.$total_ng.$sep.$total_exento_a.$sep.$total_iva.$sep.$tot_mes.$enter;
fputs($DescriptorFichero,$string5);
...
<?
	$string5 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."08".$sep."Servicios Prestados Voluntarios".$sep.$sep.$sep.$sep.$tot.$enter;
fputs($DescriptorFichero,$string5);
...
$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."09".$sep;
...
<?
$string0 =$sep.$uno."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$dos."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$tres."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$cuatro."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$cinco."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$seis."/".$anio;fputs($DescriptorFichero,$string0);
...
$string0 = $sep.$siete."/".$anio;fputs($DescriptorFichero,$string0);

$ocho = $siete+ 1;
if ($ocho == 13){$ocho = 1;$anio = $anio + 1;}
	?>
<td><div align="center"><strong><?echo $ocho;?> /  <?echo $anio;?></strong></div></td>
<?$string0 = $sep.$ocho."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$nueve."/".$anio;fputs($DescriptorFichero,$string0);
...
<?$string0 = $sep.$diez."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$once."/".$anio;fputs($DescriptorFichero,$string0);
...
<?
$string0 = $sep.$doce."/".$anio.$enter;fputs($DescriptorFichero,$string0);
...
$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."10".$sep;fputs($DescriptorFichero,$string0);
...
?><td><div align="right"><?echo $importe;?></div></td><?
	...
	$string0 = $importe.$sep;fputs($DescriptorFichero,$string0);
}
else
	  {
?><td><div align="center">&nbsp;</div></td><?
	$string0 = "-".$sep;fputs($DescriptorFichero,$string0);	  
}
$result10->MoveNext(); //mueve registro matricula
 
 }

$string0 = $enter;fputs($DescriptorFichero,$string0);

$tot = $total_bioq;

$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."11".$sep."TOTAL ACUMULADO DURANTE LOS ULTIMOS 12 MESES ".$sep.$tot.$enter;fputs($DescriptorFichero,$string0);
?>
<tr>
...
$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."12".$sep."DEBE REALIZAR FACTURA ELECTRONICA".$enter;fputs($DescriptorFichero,$string0);

}elseif($tot < 120000){
$leyenda ='DEBE REALIZAR FACTURA "C" O RECIBO "C"';
include ("../../../alertas/alerta_800.php");
$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."12".$sep.'DEBE REALIZAR FACTURA "C" O RECIBO "C"'.$enter;fputs($DescriptorFichero,$string0);
...
$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."13".$sep."HA SUPERADO EL MAXIMO ($200000) DE MONOTRIBUTISTA. REVISE SU SITUACION AFIP".$enter;fputs($DescriptorFichero,$string0);
...
IF ($sit_iva == 1){
$leyenda ='DEBE REALIZAR FACTURA "A" O RECIBO "A" O "M"';
include ("../../../alertas/alerta_800.php");
$string0 = $periodo_liq.$sep.$anio_liquidacion_liq.$sep.$nro_laboratorio.$sep."14".$sep.'DEBE REALIZAR FACTURA "A" O RECIBO "A" O "M"'.$enter;fputs($DescriptorFichero,$string0);
}
?>
</table>
