...
<table width="641" border="0">
 ...
 <tr bgcolor="#FFFFFF" class="Estilo7">
    <td colspan="10"><div align="right" class="Estilo24">Liquidacion N&ordm;: <?echo $nro_liquidacion;?> - Periodo: <?echo $periodo;?> - 20<?echo $anio_liquidacion;?> </div></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
?>
<tr>
    <td colspan="9"><div align="right"><span class="Estilo19">SALDO DE FACTURAS ADEUDADAS ANTERIOR A LA LIQUIDACION: <?  number_format($importe,2);?></span>
...
<tr bgcolor="#FFFFFF" class="Estilo8">
  <td colspan="9"><div align="left"><span class="Estilo14">FACTURAS PAGADAS A LA FECHA</span></div></td>
</tr>
<tr bgcolor="#FFFFFF" class="Estilo12">
  <td width="47"><div align="center" class="Estilo2">Fec. Pag </div></td>
  <td width="159"><div align="center" class="Estilo2">O.Social</div></td>
  <td width="28"><div align="center"><span class="Estilo7">%</span></div></td>
  <td width="72"><div align="center" class="Estilo2">Saldo</div></td>
  <td width="65"><div align="center" class="Estilo2">Comp.</div></td>
  <td width="55"><div align="center" class="Estilo2">Fec. Fact </div></td>
  <td width="56"><div align="center" class="Estilo2">Imp. Orig</div></td>
  <td width="61"><div align="center" class="Estilo2">Exc Capita</div></td>
...
<tr class="Estilo7">
  <td colspan="9" class="Estilo19" scope="col"><div align="right">SALDO ACTUALIZADO DE FACTURAS ACREEDITADAS PENDIENTES DE PAGO:  <? number_format($importe,2);?></div></td>
  <tr class="Estilo7">
...
?>   <tr class="Estilo7">
    ...
    <td width="50" scope="col"><span class="Estilo2"><?ECHO $sigla;?></span></td>
    <td width="41" scope="col"><div align="center"><span class="Estilo2"><?ECHO $nro_factura;?></span></div></td>
    <td width="32" scope="col"><div align="center"><span class="Estilo2"><?ECHO $fecha;?></span></div></td>
    <td width="267" scope="col"><div align="left"><span class="Estilo2"><?ECHO $motivo;?></span></div></td><td width="52" scope="col"><div align="center"><span class="Estilo2"> - </span></div></td>
...
?>  
  ...
  <tr class="Estilo7">
    ...
    <td width="41" scope="col"><div align="center"><span class="Estilo2"><?ECHO $nro_factura;?></span></div></td>
    <td width="32" scope="col"><div align="center"><span class="Estilo2"><?ECHO $fecha;?></span></div></td>
    <td width="267" scope="col"><div align="left"><span class="Estilo2"><?ECHO $motivo;?></span></div></td>
    <td scope="col"><?ECHO number_format($importe,2);?></td>
    <td scope="col"><div align="right">-</div></td>
    <td width="63" scope="col"><div align="right"><?ECHO number_format($saldo_debitos,2);?></div></td>
  </tr>
<?	
 ...
 <table width="641" border="0">
  <tr bgcolor="#FFFFFF">
    <td colspan="8" scope="col"><div align="center" class="Estilo12">
      <div align="left"><strong>AJUSTES SOBRE FACTURAS LIQUIDADAS ANTERIORMENTE</strong></div>
    </div></td>
  </tr>
  <tr bgcolor="#FFFFFF" class="Estilo8">
    <td width="58" scope="col"><div align="center" class="Estilo3 Estilo4 Estilo9"><span class="Estilo5  Estilo2">Fec. Mov. </span></div></td>
    <td width="84" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">O. Social </span></div></td>
    <td width="31" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Comp.</span></div></td>
    <td width="66" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Fec. Orig.</span></div></td>
    <td width="233" scope="col"><div align="center" class="Estilo5 Estilo9">Motivo</div></td>
    
	<td width="38" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Debitos</span></div></td>
    <td width="38" scope="col"><div align="center" class="Estilo5 Estilo9">Cr&eacute;dito</div></td>
    
	<td width="59" scope="col"><div align="center" class="Estilo5 Estilo9"><span class="Estilo5">Neto</span></div></td>
  </tr>
...
<table width="641" border="0">
  <!--DWLayoutTable-->
<tr class="Estilo7">
    <td width="47" scope="col"><span class="Estilo2"><?ECHO $fecha;?></span></td>
    <td width="92" scope="col"><span class="Estilo2"><?ECHO $sigla;?></span></td>
    <td width="34" scope="col"><div align="center"><span class="Estilo2"><?ECHO $nro_factura;?></span></div></td>
    <td width="65" scope="col"><div align="center"><span class="Estilo2"><?ECHO $fecha;?></span></div></td>
    <td width="236" scope="col"><div align="left"><span class="Estilo2"><?ECHO $motivo;?></span></div></td>
...
?> <td width="37" scope="col"><div align="right"><span class="Estilo2"> - </span></div></td>
    <td width="40" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($importe,2);?></span></div></td>
<td width="56" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($saldo,2);?></span></div></td>
  </tr>
<?
		break;}
...
?>  
<td width="37" scope="col"><div align="right"><span class="Estilo2"> <?ECHO number_format($importe,2);?></span></div></td>
    <td width="40" scope="col"><div align="right"><span class="Estilo2">-</span></div></td>
<td width="56" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($saldo,2);?></span></div></td>
  </tr>
<?	
...
<tr class="Estilo7">
  <td colspan="5" scope="col"><div align="right" class="Estilo2">Sub-Total </div></td>
  <td width="41" class="Estilo2" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($total_debito,2);?></span></div></td>
  <td width="39" class="Estilo2" scope="col"><div align="right"><span class="Estilo2"><?ECHO number_format($total_credito,2);?></span></div></td>
  <td width="54" class="Estilo2" scope="col"><div align="right" class="Estilo6">
...
<table width="641" border="0">
  ...
  <tr bgcolor="#000099" class="Estilo8">
    ...
    <td width="98" bgcolor="#FFFFFF" scope="col"><div align="center" class="Estilo2 Estilo5 Estilo6 Estilo8 Estilo28 Estilo9">Importe</span> Descontado</div></td>
...
<tr class="Estilo7">
    ...
    <div align="right"><?ECHO round($saldo_retenciones_adm,2);?></div>
</TABLE>
...
?>  
  ...
  <tr class="Estilo7">
    ...
    <td width="107" class="Estilo2" scope="col"><div align="left"><span class="Estilo10"><?ECHO number_format($acumulado_mensual,2);?></span></div></td>
    <td width="93" valign="top" class="Estilo2" scope="col">      <div align="right">
      <?
	ECHO number_format($importe,2);?>    
    </div>
    <td width="85" class="Estilo2" scope="col"><div align="right"><span class="Estilo2"><?ECHO round($saldo_retenciones_adm,2);?></span> </div></table>
...
if ($importe > 0){
 ...
 <tr class="Estilo7">
    ...
    <td width="84" class="Estilo2" scope="col"><div align="right"><span class="Estilo2"><?ECHO round($saldo_retenciones_adm,2);?></span> </div></table>
<?
...
<table width="641" border="0">
  <!--DWLayoutTable-->
<tr class="Estilo7">
  <td colspan="3" valign="top" class="Estilo2" scope="col"><!--DWLayoutEmptyCell-->&nbsp;</td>
  <td colspan="6" valign="top" class="Estilo2" scope="col"><hr noshade></td>
  </tr>
<tr class="Estilo7"><td colspan="4" valign="top" class="Estilo2" scope="col"><div align="right" class="Estilo2">Sub -Total Neto Retenciones y Aportes</div></td>
  <td colspan="2" valign="top" class="Estilo2" scope="col"><div align="right"><span class="Estilo7"><?ECHO number_format($total_importe,2);?>
  </span></div></td>
  <td colspan="3" valign="top" scope="col"><div align="right" class="Estilo6">
...
<tr class="Estilo2">
  <td colspan="9" valign="top" class="Estilo2" scope="col"><hr noshade></td>
  </tr>
...
?>	
  ...
  <tr bgcolor="#FFFFFF" class="Estilo8">
    <td width="77" class="Estilo5" scope="col"><div align="center" class="Estilo4 Estilo3 Estilo28 Estilo9"><span class="Estilo5  Estilo2">Fec. Mov. </span></div></td>
    <td width="227" class="Estilo5" scope="col"><div align="center" class="Estilo5 Estilo28 Estilo9"><span class="Estilo5">Motivo</span></div></td>
  ...
  <!--   <td width="59" class="Estilo5" scope="col"><div align="center" class="Estilo5">Fec. Orig<span class="Estilo7 ">.</span></div></td> -->
    <td width="90" class="Estilo5" scope="col"><div align="center" class="Estilo5 Estilo28 Estilo9"><span class="Estilo5">Debitos</span></div></td>
    <td colspan="2" class="Estilo5" scope="col"><div align="center" class="Estilo5 Estilo28 Estilo9">Cr&eacute;dito</div></td>
    <td width="74" colspan="2" class="Estilo5" scope="col"><div align="center" class="Estilo5 Estilo28 Estilo9"><span class="Estilo5">Neto</span></div></td>
  </tr>
  

 <tr bgcolor="#FFFFFF" class="Estilo8">
    <td colspan="2" class="Estilo5" scope="col"><span class="Estilo2"><span class="Estilo25">SUB - TOTAL NETO DE RETENCIONES </span></span></td>
    <td colspan="7" class="Estilo5 Estilo9" scope="col"><div align="right"><?ECHO number_format($importe,2);?></div></td>
  </tr>
<?
...
break;
	...
	case "11000": // acreeditaciones y descuentos
	{
...
<td width="73" class="Estilo7" scope="col"><div align="right"><span class="Estilo7">- <? number_format($importe,2);?></span></div></td>
<td width="73" scope="col"><div align="right"><span class="Estilo7"> <? echo round($saldo_novedades,2);?></span></div></td>
  </tr></table>
<?	
...
?><table width="641" border="0"><tr>
  ...
  <tr>
    ...
    <td width="92" class="Estilo2" scope="col"><div align="right">
...
<tr class="Estilo6 Estilo4 Estilo9">
  <td colspan="11" bgcolor="#FFFFFF" class="Estilo6 Estilo4 Estilo9"  scope="col"><CENTER><STRONG>SR/SRES. <?echo $nombre_laboratorio;?> al día <?echo $fecha_hoy=date("d/m/Y");?> <BR><BR>REGISTRA UNA DEUDA CON LA ASOCIACION DE: $  <?echo NUMBER_FORMAT($saldo_total,2);?></STRONG></CENTER></td>
</tr>
...
if ($acree != 1){
  ...
  <td colspan="10" bgcolor="#FFFFFF" class="Estilo6 Estilo4 Estilo9"  scope="col">&nbsp;</td>
    ...
    <tr class="Estilo6 Estilo4 Estilo9">
      <td colspan="9" bgcolor="#FFFFFF" class="Estilo6 Estilo4 Estilo9"  scope="col"><div align="right">REGISTRA UNA DEUDA CON LA ASOCIACION DE: $ </div></td>
      <td bgcolor="#FFFFFF" class="Estilo6 Estilo4 Estilo9"  scope="col"><div align="right"><?echo NUMBER_FORMAT($saldo_1,2);?></div></td>
    </tr></table>
