...
var dir_imagenes = 'c:/utiles/easyphp1-7/www/bioquimica/drivers/cal/acc_calendar'; //Direcctorio donde se encuentren las imágenes
var preposiciones = {
...
function calendario(cons_disp,todact,mes,year,nuevo,id,rango,dia) {
	...
	if(!document.getElementById('niquelao')) {
		...
		niquelao.src = dir_imagenes + '/niquela.png';
		niquelao.setAttribute('alt','');
