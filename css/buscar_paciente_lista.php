...
<table width="784" border="1" cellspacing="0">
  ...
  <tr bgcolor="#CECECE">
    <td colspan="7" valign="top"><div align="center"><img src="../../imagenes/titulo_personal.jpg"></div></td>
  </tr>
  <tr>
...
//$sql="select * from pacientes  where ultima_fecha between '$desde' and '$hasta' order by  apellido, nombre, ultima_fecha, nro_llegada, nombre";
